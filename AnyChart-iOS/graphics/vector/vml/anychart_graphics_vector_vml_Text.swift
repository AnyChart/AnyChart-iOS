 ...
 */
 extension anychart.graphics.vector.vml {
     ...
     */
    public func appendTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func attr(key: String, value: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func clip(value: anychart.graphics.math.Rect) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func color(color: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func cursor(value: anychart.graphics.vector.Cursor) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func decoration(value: anychart.graphics.vector.text.Decoration) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func desc(value: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func direction(direction: anychart.graphics.vector.text.Direction) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func disablePointerEvents(value: Bool) -> anychart.graphics.vector.vml.Text {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public func disableStrokeScaling(value: Bool) -> anychart.graphics.vector.vml.Text {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public func drag(value: Bool) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func fontFamily(family: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func fontSize(size: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func fontStyle(style: anychart.graphics.vector.text.FontStyle) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func fontVariant(value: anychart.graphics.vector.text.FontVariant) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func fontWeight(weight: String) -> anychart.graphics.vector.vml.Text {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public func hAlign(align: anychart.graphics.vector.text.HAlign) -> anychart.graphics.vector.vml.Text {
...
<b>Note:</b> it is not calculated automatically and has no default, and if it was not set using setter - <b>NaN</b> is returned.
     ...
     * Sets a height.
     */
    public func height(height: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func htmlText(value: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func id(id: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func letterSpacing(spacing: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func lineHeight(height: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func opacity(opacity: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func parent(parent: anychart.graphics.vector.Layer) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func remove() -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func rotate(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func rotateByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func scale(sx: Double, sy: Double, cx: Double, cy: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func scaleByAnchor(sx: Double, sy: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.vml.Text {
...
Defines whether text can be selected. If <b>false</b> - no selection.
     */
    public func selectable(enabled: Bool) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func setPosition(x: Double, y: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func setRotation(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.vml.Text {
     ...
     * Rotates a shape around the given anchor.
     */
    public func setRotationByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func setTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.vml.Text {
     ...
     * Setter for the text.
     */
    public func text(text: String) -> anychart.graphics.vector.vml.Text {
...
The text-indent property specifies the indentation of the first line in a text-block.
     */
    public func textIndent(indent: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func textOverflow(value: anychart.graphics.vector.text.TextOverflow) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func title(value: String) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func translate(tx: Double, ty: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func vAlign(align: anychart.graphics.vector.text.VAlign) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func visible(isVisible: Bool) -> anychart.graphics.vector.vml.Text {
...
<b>Note:</b> it is not calculated automatically and has no default, and if it  was not set using setter - <b>NaN</b> is returned.
     ...
     * Sets a width.
     */
    public func width(width: Double) -> anychart.graphics.vector.vml.Text {
...
More at: <a href='https://www.w3schools.com/cssref/css3_pr_word-break.asp'>Word-break Property</a>
     ...
     */
    public func wordBreak(value: String) -> anychart.graphics.vector.vml.Text {
...
More at: <a href='https://www.w3schools.com/cssref/css3_pr_word-wrap.asp'>Word-wrap Property</a>
     ...
     */
    public func x(xCoord: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func y(yCoord: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func zIndex(value: Double) -> anychart.graphics.vector.vml.Text {
     ...
     */
    public func path(path: anychart.graphics.vector.Path) -> anychart.graphics.vector.vml.Text {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: "\(self.jsBase).path()")
