 ...
 */
 extension anychart.core.cartesian.series {
    public class Area: anychart.core.cartesian.series.ContinuousBase {
        ...
        public override init() {
            //return Area(jsBase: "new anychart.core.cartesian.series.Area()")
            super.init(jsBase: "new anychart.core.cartesian.series.Area()")
        }
