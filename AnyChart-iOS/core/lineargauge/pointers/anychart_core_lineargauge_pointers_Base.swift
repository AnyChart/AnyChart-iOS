 ...
 extension anychart.core.lineargauge.pointers {
    public class Base: JsObject {
        ...
        public static func instantiate() -> Base {
            return Base(jsChart: "new anychart.core.linearGauge.pointers.Base()")
        }
     ...
     * Getter for pointers data.
     */
    public func data(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.lineargauge.pointers.Base {
     ...
     * Getter for pointers data.
     */
    public func data(data: anychart.data.Set, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.lineargauge.pointers.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Getter for pointers data.
     */
    public func data(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.lineargauge.pointers.Base {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.core.lineargauge.pointers.Base {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.core.lineargauge.pointers.Base {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.lineargauge.pointers.Base {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.lineargauge.pointers.Base {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.lineargauge.pointers.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.lineargauge.pointers.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.lineargauge.pointers.Base {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.lineargauge.pointers.Base {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.lineargauge.pointers.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.lineargauge.pointers.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.lineargauge.pointers.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.lineargauge.pointers.Base {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.lineargauge.pointers.Base {
