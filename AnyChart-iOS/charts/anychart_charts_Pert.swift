 ...
 */
 extension anychart.charts {
    public class Pert: JsObject {

        override init() {

        }

        public static func instantiate() -> Pert {
            return Pert(jsChart: "new anychart.charts.Pert()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "pert\(JsObject.variableIndex)"
     ...
     */
    public func a11y(settings: Bool) -> anychart.charts.Pert {
     ...
     */
    public func animation(settings: Bool) -> anychart.charts.Pert {
     ...
     */
    public func animation(enabled: Bool, duration: Double) -> anychart.charts.Pert {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public func autoRedraw(enabled: Bool) -> anychart.charts.Pert {
     ...
     */
    public func background(settings: String) -> anychart.charts.Pert {
     ...
     */
    public func bottom(bottom: Double) -> anychart.charts.Pert {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.charts.Pert {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.charts.Pert {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.charts.Pert {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.charts.Pert {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.charts.Pert {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.charts.Pert {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.charts.Pert {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.charts.Pert {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.charts.Pert {
     ...
     */
    public func cancelMarquee() -> anychart.charts.Pert {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.charts.Pert {
     ...
     * Setter for the element's container.
     */
    public func container(element: String) -> anychart.charts.Pert {
     ...
     */
    public func contextMenu(settings: String) -> anychart.charts.Pert {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public func credits(value: String) -> anychart.charts.Pert {
    ...
    public func criticalPath() -> anychart.core.pert.CriticalPath {
        return anychart.core.pert.CriticalPath(jsChart: jsBase + ".criticalPath()")
    }
    /**
     * Setter for the critical path settings.
     */
    public func criticalPath(settings: String) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".criticalPath(%s);", JsObject.wrapQuotes(value: settings)))
     ...
     */
    public func data(data: anychart.data.Tree, fillMethod: anychart.enums.TreeFillingMethod, deps: [anychart.data.tree.Dependency]) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s, %s);", (data != nil) ? data.getJsBase() : "null", (fillMethod != nil) ? fillMethod.getJsBase() : "null", JsObject.arrayToString(jsObjects: deps)))
     ...
     * Setter for the chart data.
     */
    public func data(data: anychart.data.TreeView, fillMethod: anychart.enums.TreeFillingMethod, deps: [anychart.data.tree.Dependency]) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s, %s);", (data != nil) ? data.getJsBase() : "null", (fillMethod != nil) ? fillMethod.getJsBase() : "null", JsObject.arrayToString(jsObjects: deps)))
     ...
     * Setter for the chart data.
     */
    public func data(data: [String], fillMethod: anychart.enums.TreeFillingMethod, deps: [anychart.data.tree.Dependency]) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s, %s);", JsObject.arrayToStringWrapQuotes(array: data), (fillMethod != nil) ? fillMethod.getJsBase() : "null", JsObject.arrayToString(jsObjects: deps)))
     ...
     */
    public func draw(async: Bool) -> anychart.charts.Pert {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.charts.Pert {
    ...
    public func expectedTimeCalculator()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".expectedTimeCalculator();")
    }
    /**
     ...
     */
    public func exports(settings: String) -> anychart.charts.Pert {
     ...
     */
    public func fullScreen(enabled: Bool) -> anychart.charts.Pert {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public func height(height: Double) -> anychart.charts.Pert {
    ...
    public func horizontalSpacing()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".horizontalSpacing();")
    }
    /**
     * Setter for milestones horizontal spacing.
     */
    public func horizontalSpacing(spacing: Double) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".horizontalSpacing(%s);", spacing))
     ...
     * Setter for chart id.
     */
    public func id(id: String) -> anychart.charts.Pert {
     ...
     */
    public func interactivity(settings: String) -> anychart.charts.Pert {
     ...
     */
    public func label(settings: Bool) -> anychart.charts.Pert {
     ...
     * Setter for the chart label.
     */
    public func label(index: String, settings: Bool) -> anychart.charts.Pert {
     ...
     * Setter for the chart label.
     */
    public func label(index: Double, settings: Bool) -> anychart.charts.Pert {
     ...
     */
    public func left(left: Double) -> anychart.charts.Pert {
     ...
     */
    public func legend(settings: String) -> anychart.charts.Pert {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public func margin(margin: [Double]) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public func margin(margin: String) -> anychart.charts.Pert {
     ...
     */
    public func margin(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     */
    public func maxHeight(height: Double) -> anychart.charts.Pert {
     ...
     */
    public func maxWidth(width: Double) -> anychart.charts.Pert {
     ...
     */
    public func minHeight(height: Double) -> anychart.charts.Pert {
     ...
     */
    public func minWidth(width: Double) -> anychart.charts.Pert {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public func noData(settings: String) -> anychart.charts.Pert {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public func padding(padding: [Double]) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public func padding(padding: String) -> anychart.charts.Pert {
     ...
     */
    public func padding(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.Pert {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.Pert {
     ...
     */
    public func right(right: Double) -> anychart.charts.Pert {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: anychart.graphics.vector.Fill) -> anychart.charts.Pert {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: [String]) -> anychart.charts.Pert {
     ...
     */
    public func selectMarqueeFill(color: String, opacity: Double) -> anychart.charts.Pert {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.charts.Pert {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.charts.Pert {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.charts.Pert {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.charts.Pert {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.Pert {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Pert {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Pert {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Pert {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Pert {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public func startSelectMarquee(repeat1: Bool) -> anychart.charts.Pert {
     ...
     */
    public func title(settings: Bool) -> anychart.charts.Pert {
     ...
     */
    public func top(top: Double) -> anychart.charts.Pert {
    ...
    public func verticalSpacing()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".verticalSpacing();")
    }
    /**
     * Setter for milestones vertical spacing.
     */
    public func verticalSpacing(settings: Double) -> anychart.charts.Pert {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".verticalSpacing(%s);", settings))
     ...
     */
    public func width(width: Double) -> anychart.charts.Pert {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.charts.Pert {
     ...
     */
    public func tooltip(settings: String) -> anychart.charts.Pert {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.charts.Pert {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.charts.Pert {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.charts.Pert {
