 ...
 */
 extension anychart.core.mekko.series {
    public class Mekko: anychart.core.cartesian.series.WidthBased {
        ...
        public override init() {
            //return Mekko(jsBase: "new anychart.core.mekko.series.Mekko()")
            super.init(jsBase: "new anychart.core.mekko.series.Mekko()")
        }
