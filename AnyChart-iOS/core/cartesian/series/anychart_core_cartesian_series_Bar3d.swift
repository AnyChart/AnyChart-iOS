 ...
 */
 extension anychart.core.cartesian.series {
    public class Bar3d: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> Bar3d {
            return Bar3d(jsChart: "new anychart.core.cartesian.series.Bar3d()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "bar3d\(JsObject.variableIndex)"
     ...
     */
    public func a11y(value: Bool) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.cartesian.series.Bar3d {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func clip(value: Bool) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.cartesian.series.Bar3d {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (value != nil) ? value.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: anychart.data.Set, csvSettings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.cartesian.series.Bar3d {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: value), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: String, csvSettings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func error(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for the series error.
     */
    public func error(settings: Double) -> anychart.core.cartesian.series.Bar3d {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func height(height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Hovers points.
     */
    public func hover() -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func hover(index: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func hover(indexes: [Double]) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func hovered(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func id(id: String) -> anychart.core.cartesian.series.Bar3d {
...
Set it to null to reset to the default. {docs:Basic_Charts/Vertical/Overview}Learn more about Vertical chart.{docs}
     */
    public func isVertical(enabled: Bool) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func labels(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func left(left: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func legendItem(value: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func markers(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func maxLabels(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func maxPointWidth(width: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func meta(object: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func meta(key: String, value: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func minLabels(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func minPointLength(length: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func name(value: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func normal(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func pointWidth(width: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func rendering(settings: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func right(right: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func select(index: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func select(indexes: [Double]) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func selected(settings: String) -> anychart.core.cartesian.series.Bar3d {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public func selectionMode(value: anychart.enums.SelectionMode) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func seriesType(type: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     * 
     */
    public func tooltip(value: String) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func top(top: Double) -> anychart.core.cartesian.series.Bar3d {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func unhover(indexOrIndexes: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func unselect() -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func unselect(index: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func unselect(indexes: [Double]) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func width(width: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func xPointPosition(position: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func xScale(settings: anychart.scales.Base) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for the series X scale.
     */
    public func xScale(settings: anychart.enums.ScaleTypes) -> anychart.core.cartesian.series.Bar3d {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".xScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func yScale(settings: anychart.scales.Base) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for the series Y scale.
     */
    public func yScale(settings: anychart.enums.ScaleTypes) -> anychart.core.cartesian.series.Bar3d {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.cartesian.series.Bar3d {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.cartesian.series.Bar3d {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.cartesian.series.Bar3d {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.cartesian.series.Bar3d {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.cartesian.series.Bar3d {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.cartesian.series.Bar3d {
