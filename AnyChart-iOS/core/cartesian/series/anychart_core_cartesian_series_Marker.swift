 ...
 */
 extension anychart.core.cartesian.series {
    public class Marker: anychart.core.cartesian.series.Base {
        ...
        public override init() {
            //return Marker(jsBase: "new anychart.core.cartesian.series.Marker()")
            super.init(jsBase: "new anychart.core.cartesian.series.Marker()")
        }
