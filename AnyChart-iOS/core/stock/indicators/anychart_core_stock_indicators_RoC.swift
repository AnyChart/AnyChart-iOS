 ...
 extension anychart.core.stock.indicators {
    public class RoC: JsObject {
        ...
        public override init() {
            super.init()
            //return RoC(jsBase: "new anychart.core.stock.indicators.RoC()")
            //super.init(jsBase: "new anychart.core.stock.indicators.RoC()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "roC\(JsObject.variableIndex)"
            APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: self.jsBase + " = " + jsBase + ";")
        }

        public func instantiate() -> anychart.core.stock.indicators.RoC {
            return anychart.core.stock.indicators.RoC(jsBase: "new anychart.core.stock.indicators.roc()")
        }
     ...
     * Setter for the indicator RoC series type.
     */
    public func series(type: String) -> anychart.core.stock.indicators.RoC {
