 ...
 */
 extension anychart.core.cartesian.series {
    public class Hilo: JsObject {

        override init() {

        }

        public static func instantiate() -> Hilo {
            return Hilo(jsChart: "new anychart.core.cartesian.series.Hilo()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "hilo\(JsObject.variableIndex)"
     ...
     */
    public func a11y(value: Bool) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.cartesian.series.Hilo {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func clip(value: Bool) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func color(value: anychart.graphics.vector.Fill) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.cartesian.series.Hilo {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (value != nil) ? value.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: anychart.data.Set, csvSettings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.cartesian.series.Hilo {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: value), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: String, csvSettings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func height(height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * Hovers points.
     */
    public func hover() -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func hover(index: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func hover(indexes: [Double]) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func hovered(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func id(id: String) -> anychart.core.cartesian.series.Hilo {
...
Set it to null to reset to the default. {docs:Basic_Charts/Vertical/Overview}Learn more about Vertical chart.{docs}
     */
    public func isVertical(enabled: Bool) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func labels(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func left(left: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func legendItem(value: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func markers(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func maxLabels(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func meta(object: String) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func meta(key: String, value: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func minLabels(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func name(value: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func normal(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func rendering(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func right(right: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func select(index: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func select(indexes: [Double]) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func selected(settings: String) -> anychart.core.cartesian.series.Hilo {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public func selectionMode(value: anychart.enums.SelectionMode) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func seriesType(type: String) -> anychart.core.cartesian.series.Hilo {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.cartesian.series.Hilo {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.cartesian.series.Hilo {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.cartesian.series.Hilo {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.cartesian.series.Hilo {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.cartesian.series.Hilo {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func stroke(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     * 
     */
    public func tooltip(value: String) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func top(top: Double) -> anychart.core.cartesian.series.Hilo {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func unhover() -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func unselect() -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func unselect(index: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func unselect(indexes: [Double]) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func width(width: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func xPointPosition(position: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func xScale(settings: anychart.scales.Base) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for the series X scale.
     */
    public func xScale(settings: anychart.enums.ScaleTypes) -> anychart.core.cartesian.series.Hilo {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".xScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func yScale(settings: anychart.scales.Base) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for the series Y scale.
     */
    public func yScale(settings: anychart.enums.ScaleTypes) -> anychart.core.cartesian.series.Hilo {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func connectMissingPoints(enabled: Bool) -> anychart.core.cartesian.series.Hilo {
     ...
     */
    public func error(settings: String) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for the series error.
     */
    public func error(settings: Double) -> anychart.core.cartesian.series.Hilo {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.cartesian.series.Hilo {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.cartesian.series.Hilo {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.cartesian.series.Hilo {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.cartesian.series.Hilo {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.cartesian.series.Hilo {
