 ...
 */
 extension anychart.core.axes {
    public class CircularTicks: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> CircularTicks {
            return CircularTicks(jsChart: "new anychart.core.axes.CircularTicks()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "circularTicks\(JsObject.variableIndex)"
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.axes.CircularTicks {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.core.axes.CircularTicks {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.core.axes.CircularTicks {
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
    ...
    public func position(value: anychart.enums.SidePosition) -> anychart.core.axes.CircularTicks {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".position(%s);", (value != nil) ? value.getJsBase() : "null"))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.axes.CircularTicks {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.axes.CircularTicks {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.axes.CircularTicks {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.axes.CircularTicks {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.axes.CircularTicks {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.axes.CircularTicks {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.axes.CircularTicks {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.axes.CircularTicks {
