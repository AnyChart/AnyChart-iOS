 ...
 extension anychart.core.stock.series {
    public class JumpLine: JsObject {
        ...
        public static func instantiate() -> JumpLine {
            return JumpLine(jsChart: "new anychart.core.stock.series.JumpLine()")
        }
     ...
     */
    public func allowPointSettings(enabled: Bool) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.stock.series.JumpLine {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func height(height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func hovered(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func labels(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func left(left: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func legendItem(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func markers(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func maxLabels(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func minLabels(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func name(name: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func normal(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func rendering(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func right(right: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func seriesType(type: String) -> anychart.core.stock.series.JumpLine {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.stock.series.JumpLine {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.stock.series.JumpLine {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.stock.series.JumpLine {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.stock.series.JumpLine {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.stock.series.JumpLine {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func stroke(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func tooltip(settings: String) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func top(top: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func width(width: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func yScale(settings: anychart.scales.ScatterBase) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for the Y-scale.
     */
    public func yScale(settings: anychart.enums.ScaleTypes) -> anychart.core.stock.series.JumpLine {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func maxPointWidth(width: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func minPointLength(length: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func pointWidth(width: Double) -> anychart.core.stock.series.JumpLine {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.stock.series.JumpLine {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.stock.series.JumpLine {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.stock.series.JumpLine {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.stock.series.JumpLine {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.stock.series.JumpLine {
