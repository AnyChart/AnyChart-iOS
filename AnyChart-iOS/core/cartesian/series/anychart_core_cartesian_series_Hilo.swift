 ...
 */
 extension anychart.core.cartesian.series {
    public class Hilo: anychart.core.cartesian.series.ContinuousBase {
        ...
        public override init() {
            //return Hilo(jsBase: "new anychart.core.cartesian.series.Hilo()")
            super.init(jsBase: "new anychart.core.cartesian.series.Hilo()")
        }
