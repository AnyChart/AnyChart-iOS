 ...
 */
 extension anychart.core.cartesian.series {
    public class Stick: anychart.core.cartesian.series.WidthBased {
        ...
        public override init() {
            //return Stick(jsBase: "new anychart.core.cartesian.series.Stick()")
            super.init(jsBase: "new anychart.core.cartesian.series.Stick()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "stick\(JsObject.variableIndex)"
