 ...
 */
 extension anychart.core.radar.series {
    public class Area: anychart.core.radar.series.ContinuousBase {
        ...
        public override init() {
            //return Area(jsBase: "new anychart.core.radar.series.Area()")
            super.init(jsBase: "new anychart.core.radar.series.Area()")
        }
