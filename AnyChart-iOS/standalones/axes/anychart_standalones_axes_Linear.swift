 ...
 extension anychart.standalones.axes {
    public class Linear: JsObject {
        ...
        public static func instantiate() -> Linear {
            return Linear(jsChart: "new anychart.standalones.axes.Linear()")
        }
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.standalones.axes.Linear {
     ...
     * Setter for the axis container.
     */
    public func container(element: String) -> anychart.standalones.axes.Linear {
     ...
     */
    public func drawFirstLabel(enabled: Bool) -> anychart.standalones.axes.Linear {
     ...
     */
    public func drawLastLabel(enabled: Bool) -> anychart.standalones.axes.Linear {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.standalones.axes.Linear {
     ...
     */
    public func labels(settings: String) -> anychart.standalones.axes.Linear {
     ...
     */
    public func minorLabels(settings: String) -> anychart.standalones.axes.Linear {
     ...
     */
    public func minorTicks(settings: String) -> anychart.standalones.axes.Linear {
     ...
     */
    public func orientation(orientation: anychart.enums.Orientation) -> anychart.standalones.axes.Linear {
     ...
     */
    public func overlapMode(mode: anychart.enums.LabelsOverlapMode) -> anychart.standalones.axes.Linear {
     ...
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.standalones.axes.Linear {
     ...
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.standalones.axes.Linear {
     ...
     */
    public func scale(settings: anychart.scales.Base) -> anychart.standalones.axes.Linear {
     ...
     * Setter for the axis scale.
     */
    public func scale(settings: anychart.enums.ScaleTypes) -> anychart.standalones.axes.Linear {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".scale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
...
<b>Note:</b> pass <b>null</b> to enable autocalculation.
     */
    public func staggerLines(count: Double) -> anychart.standalones.axes.Linear {
     ...
     */
    public func staggerMaxLines(count: Double) -> anychart.standalones.axes.Linear {
     ...
     */
    public func staggerMode(enabled: Bool) -> anychart.standalones.axes.Linear {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.standalones.axes.Linear {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.standalones.axes.Linear {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.standalones.axes.Linear {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.standalones.axes.Linear {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.standalones.axes.Linear {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.standalones.axes.Linear {
     ...
     */
    public func stroke(settings: String) -> anychart.standalones.axes.Linear {
     ...
     */
    public func ticks(settings: String) -> anychart.standalones.axes.Linear {
     ...
     */
    public func title(settings: Bool) -> anychart.standalones.axes.Linear {
     ...
     */
    public func width(width: Double) -> anychart.standalones.axes.Linear {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.standalones.axes.Linear {
