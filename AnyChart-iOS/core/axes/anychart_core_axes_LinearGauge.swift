 ...
 extension anychart.core.axes {
    public class LinearGauge: JsObject {
        ...
        public static func instantiate() -> LinearGauge {
            return LinearGauge(jsChart: "new anychart.core.axes.LinearGauge()")
        }
     ...
     */
    public func drawFirstLabel(enabled: Bool) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func drawLastLabel(enabled: Bool) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func labels(settings: String) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func minorLabels(settings: String) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func minorTicks(settings: String) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func orientation(orientation: anychart.enums.Orientation) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func overlapMode(mode: anychart.enums.LabelsOverlapMode) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func scale(settings: anychart.scales.Base) -> anychart.core.axes.LinearGauge {
     ...
     * Setter for the axis scale.
     */
    public func scale(settings: anychart.enums.ScaleTypes) -> anychart.core.axes.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".scale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
...
<b>Note:</b> pass <b>null</b> to enable autocalculation.
     */
    public func staggerLines(count: Double) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func staggerMaxLines(count: Double) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func staggerMode(enabled: Bool) -> anychart.core.axes.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.axes.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.axes.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.axes.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.axes.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.axes.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(value: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func stroke(settings: String) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func ticks(settings: String) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func title(settings: Bool) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func width(width: Double) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.axes.LinearGauge {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.axes.LinearGauge {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.axes.LinearGauge {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.axes.LinearGauge {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.axes.LinearGauge {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.axes.LinearGauge {
