 ...
 */
 extension anychart.core.cartesian.series {
    public class DiscreteBase: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> DiscreteBase {
            return DiscreteBase(jsChart: "new anychart.core.cartesian.series.DiscreteBase()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "discreteBase\(JsObject.variableIndex)"
     ...
     */
    public func a11y(value: Bool) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func unhover(index: Double) -> anychart.core.cartesian.series.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".unhover(%s);", index))
     ...
     */
    public func unhover(indexes: [Double]) -> anychart.core.cartesian.series.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".unhover(%s);", indexes.map{String($0)}.joined(separator: ",")))
     ...
     */
    public func unselect() -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func unselect(index: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func unselect(indexes: [Double]) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.cartesian.series.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func clip(value: Bool) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func color(value: anychart.graphics.vector.Fill) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.cartesian.series.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (value != nil) ? value.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: anychart.data.Set, csvSettings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.cartesian.series.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: value), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: String, csvSettings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func error(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for the series error.
     */
    public func error(settings: Double) -> anychart.core.cartesian.series.DiscreteBase {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func height(height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Hovers points.
     */
    public func hover() -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func hover(index: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func hover(indexes: [Double]) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func hovered(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func id(id: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func labels(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func left(left: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func legendItem(value: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func markers(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func maxLabels(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func meta(object: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func meta(key: String, value: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func minLabels(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func name(value: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func normal(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func right(right: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func select(index: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func select(indexes: [Double]) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func selected(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public func selectionMode(value: anychart.enums.SelectionMode) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * 
     */
    public func tooltip(value: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func top(top: Double) -> anychart.core.cartesian.series.DiscreteBase {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func width(width: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func xPointPosition(position: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func xScale(settings: anychart.scales.Base) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for the series X scale.
     */
    public func xScale(settings: anychart.enums.ScaleTypes) -> anychart.core.cartesian.series.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".xScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func yScale(settings: anychart.scales.Base) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for the series Y scale.
     */
    public func yScale(settings: anychart.enums.ScaleTypes) -> anychart.core.cartesian.series.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
...
Set it to null to reset to the default. {docs:Basic_Charts/Vertical/Overview}Learn more about Vertical chart.{docs}
     */
    public func isVertical(enabled: Bool) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func rendering(settings: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func seriesType(type: String) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.cartesian.series.DiscreteBase {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.cartesian.series.DiscreteBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.cartesian.series.DiscreteBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.cartesian.series.DiscreteBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.cartesian.series.DiscreteBase {
