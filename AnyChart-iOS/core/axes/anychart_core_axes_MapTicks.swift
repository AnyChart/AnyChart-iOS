 ...
 */
 extension anychart.core.axes {
    public class MapTicks: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> MapTicks {
            return MapTicks(jsChart: "new anychart.core.axes.MapTicks()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "mapTicks\(JsObject.variableIndex)"
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.axes.MapTicks {
     ...
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.axes.MapTicks {
     ...
     * Setter for ticks stroke settings.
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.axes.MapTicks {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.axes.MapTicks {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.axes.MapTicks {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.axes.MapTicks {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.axes.MapTicks {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.axes.MapTicks {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.axes.MapTicks {
