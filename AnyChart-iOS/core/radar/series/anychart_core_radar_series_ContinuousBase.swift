 ...
 extension anychart.core.radar.series {
    public class ContinuousBase: JsObject {
        ...
        public static func instantiate() -> ContinuousBase {
            return ContinuousBase(jsChart: "new anychart.core.radar.series.ContinuousBase()")
        }
     ...
     */
    public func a11y(value: Bool) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.radar.series.ContinuousBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.radar.series.ContinuousBase {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func color(color: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func data(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for the series mapping.
     */
    public func data(data: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.radar.series.ContinuousBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for the series mapping.
     */
    public func data(data: anychart.data.Set, csvSettings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for the series mapping.
     */
    public func data(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for the series mapping.
     */
    public func data(data: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.radar.series.ContinuousBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for the series mapping.
     */
    public func data(data: String, csvSettings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func height(height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func hover() -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func hover(index: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func hover(indexes: [Double]) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func hovered(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func id(id: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func labels(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func left(left: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func legendItem(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func markers(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func maxLabels(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func meta(object: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func meta(key: String, value: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func minLabels(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.radar.series.ContinuousBase {
...
Basically, name of series is used in Legend displaying, but it can be used in tooltips as well.
     */
    public func name(name: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func normal(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func right(right: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func select(index: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func select(indexes: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func selected(settings: String) -> anychart.core.radar.series.ContinuousBase {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public func selectionMode(value: anychart.enums.SelectionMode) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func tooltip(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func top(top: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func unhover() -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func unselect() -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func unselect(index: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func unselect(indexes: [Double]) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func width(width: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func xScale(settings: anychart.scales.Base) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for the series X scale.
     */
    public func xScale(settings: anychart.enums.ScaleTypes) -> anychart.core.radar.series.ContinuousBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".xScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func yScale(settings: anychart.scales.Base) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for the series Y scale.
     */
    public func yScale(settings: anychart.enums.ScaleTypes) -> anychart.core.radar.series.ContinuousBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.radar.series.ContinuousBase {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.radar.series.ContinuousBase {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.radar.series.ContinuousBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.radar.series.ContinuousBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.radar.series.ContinuousBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.radar.series.ContinuousBase {
