 ...
 extension anychart.charts {
    public class Polar: JsObject {
        ...
        public static func instantiate() -> Polar {
            return Polar(jsChart: "new anychart.charts.Polar()")
        }
    ...
    public func area(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Area {
        return anychart.core.polar.series.Area(jsChart: String(format: jsBase + ".area(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Area series.
     */
    ...
    public func area(data: anychart.data.Set, csvSettings: String) -> anychart.core.polar.series.Area {
        return anychart.core.polar.series.Area(jsChart: String(format: jsBase + ".area(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Area series.
     */
    public func area(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Area {
        return anychart.core.polar.series.Area(jsChart: String(format: jsBase + ".area(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Area series.
     */
...
The baseline is the line relative to which the series with the negative or positive value is drawn and painted over.
    ...
    public func column(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Column {
        return anychart.core.polar.series.Column(jsChart: String(format: jsBase + ".column(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Column series.
     */
    ...
    public func column(data: anychart.data.Set, csvSettings: String) -> anychart.core.polar.series.Column {
        return anychart.core.polar.series.Column(jsChart: String(format: jsBase + ".column(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Column series.
     */
    public func column(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Column {
        return anychart.core.polar.series.Column(jsChart: String(format: jsBase + ".column(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Column series.
     */
    ...
    public func column(data: String, csvSettings: String) -> anychart.core.polar.series.Column {
        return anychart.core.polar.series.Column(jsChart: String(format: jsBase + ".column(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     ...
     */
    public func data(data: anychart.data.Set) -> anychart.charts.Polar {
     ...
     * Setter for the chart data.
     */
    public func data(data: [String]) -> anychart.charts.Polar {
...
<b>Note:</b> Works only after {@link anychart.charts.Polar#draw} is called.
    ...
    public func getSeries(id: Double) -> anychart.core.polar.series.Base {
        return anychart.core.polar.series.Base(jsChart: String(format: jsBase + ".getSeries(%s)", id))
    }
    /**
     * Getter for the series by its index.
     */
    public func getSeriesAt(index: Double) -> anychart.core.polar.series.Base {
        return anychart.core.polar.series.Base(jsChart: String(format: jsBase + ".getSeriesAt(%s)", index))
    }
    /**
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
    ...
    public func line(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Line {
        return anychart.core.polar.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Line series.
     */
    ...
    public func line(data: anychart.data.Set, csvSettings: String) -> anychart.core.polar.series.Line {
        return anychart.core.polar.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Line series.
     */
    public func line(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Line {
        return anychart.core.polar.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Line series.
     */
    ...
    public func line(data: String, csvSettings: String) -> anychart.core.polar.series.Line {
        return anychart.core.polar.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
    ...
    public func marker(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Marker {
        return anychart.core.polar.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Marker series.
     */
    ...
    public func marker(data: anychart.data.Set, csvSettings: String) -> anychart.core.polar.series.Marker {
        return anychart.core.polar.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Marker series.
     */
    public func marker(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Marker {
        return anychart.core.polar.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Marker series.
     */
    ...
    public func marker(data: String, csvSettings: String) -> anychart.core.polar.series.Marker {
        return anychart.core.polar.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
...
<b>Note</b>: You can use predefined palettes from {@link anychart.palettes}.
    ...
    public func polygon(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Polygon {
        return anychart.core.polar.series.Polygon(jsChart: String(format: jsBase + ".polygon(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Polygon series.
     */
    ...
    public func polygon(data: anychart.data.Set, csvSettings: String) -> anychart.core.polar.series.Polygon {
        return anychart.core.polar.series.Polygon(jsChart: String(format: jsBase + ".polygon(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Polygon series.
     */
    public func polygon(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Polygon {
        return anychart.core.polar.series.Polygon(jsChart: String(format: jsBase + ".polygon(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Polygon series.
     */
    ...
    public func polygon(data: String, csvSettings: String) -> anychart.core.polar.series.Polygon {
        return anychart.core.polar.series.Polygon(jsChart: String(format: jsBase + ".polygon(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
    ...
    public func polyline(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Polyline {
        return anychart.core.polar.series.Polyline(jsChart: String(format: jsBase + ".polyline(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Polyline series.
     */
    ...
    public func polyline(data: anychart.data.Set, csvSettings: String) -> anychart.core.polar.series.Polyline {
        return anychart.core.polar.series.Polyline(jsChart: String(format: jsBase + ".polyline(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Polyline series.
     */
    public func polyline(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.Polyline {
        return anychart.core.polar.series.Polyline(jsChart: String(format: jsBase + ".polyline(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Polyline series.
     */
    ...
    public func polyline(data: String, csvSettings: String) -> anychart.core.polar.series.Polyline {
        return anychart.core.polar.series.Polyline(jsChart: String(format: jsBase + ".polyline(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
    ...
    public func rangeColumn(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.RangeColumn {
        return anychart.core.polar.series.RangeColumn(jsChart: String(format: jsBase + ".rangeColumn(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Range Column series.
     */
    ...
    public func rangeColumn(data: anychart.data.Set, csvSettings: String) -> anychart.core.polar.series.RangeColumn {
        return anychart.core.polar.series.RangeColumn(jsChart: String(format: jsBase + ".rangeColumn(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Range Column series.
     */
    public func rangeColumn(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.polar.series.RangeColumn {
        return anychart.core.polar.series.RangeColumn(jsChart: String(format: jsBase + ".rangeColumn(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Range Column series.
     */
    ...
    public func rangeColumn(data: String, csvSettings: String) -> anychart.core.polar.series.RangeColumn {
        return anychart.core.polar.series.RangeColumn(jsChart: String(format: jsBase + ".rangeColumn(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: anychart.graphics.vector.Fill) -> anychart.charts.Polar {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.Polar {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Polar {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Polar {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Polar {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Polar {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
If the points of series should be sorted by X before drawing.
    ...
    public func sortPointsByX(enabled: Bool) -> anychart.charts.Polar {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".sortPointsByX(%s);", enabled))
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
    ...
    public func xAxis() -> anychart.core.axes.Polar {
        return anychart.core.axes.Polar(jsChart: jsBase + ".xAxis()")
    }
    /**
    ...
    public func xGrid(index: Double) -> anychart.core.grids.Polar {
        return anychart.core.grids.Polar(jsChart: String(format: jsBase + ".xGrid(%s)", index))
    }
    /**
    ...
    public func xMinorGrid(index: Double) -> anychart.core.grids.Polar {
        return anychart.core.grids.Polar(jsChart: String(format: jsBase + ".xMinorGrid(%s)", index))
    }
    /**
    ...
    public func yAxis() -> anychart.core.axes.Radial {
        return anychart.core.axes.Radial(jsChart: jsBase + ".yAxis()")
    }
    /**
    ...
    public func yGrid(index: Double) -> anychart.core.grids.Polar {
        return anychart.core.grids.Polar(jsChart: String(format: jsBase + ".yGrid(%s)", index))
    }
    /**
    ...
    public func yMinorGrid(index: Double) -> anychart.core.grids.Polar {
        return anychart.core.grids.Polar(jsChart: String(format: jsBase + ".yMinorGrid(%s)", index))
    }
    /**
