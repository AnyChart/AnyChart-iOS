 ...
 extension anychart.core.stock.indicators {
    public class CMF: JsObject {
        ...
        public override init() {
            super.init()
            //return CMF(jsBase: "new anychart.core.stock.indicators.CMF()")
            //super.init(jsBase: "new anychart.core.stock.indicators.CMF()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "cMF\(JsObject.variableIndex)"
            APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: self.jsBase + " = " + jsBase + ";")
        }

        public func instantiate() -> anychart.core.stock.indicators.CMF {
            return anychart.core.stock.indicators.CMF(jsBase: "new anychart.core.stock.indicators.cmf()")
        }
     ...
     * Setter for the indicator series type.
     */
    public func series(type: String) -> anychart.core.stock.indicators.CMF {
