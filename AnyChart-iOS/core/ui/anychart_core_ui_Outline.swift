 ...
 */
 extension anychart.core.ui {
    public class Outline: JsObject {

        override init() {

        }

        public static func instantiate() -> Outline {
            return Outline(jsChart: "new anychart.core.ui.Outline()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "outline\(JsObject.variableIndex)"
