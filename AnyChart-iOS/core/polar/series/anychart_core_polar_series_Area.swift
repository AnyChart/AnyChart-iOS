 ...
 */
 extension anychart.core.polar.series {
    public class Area: anychart.core.polar.series.ContinuousBase {
        ...
        public override init() {
            //return Area(jsBase: "new anychart.core.polar.series.Area()")
            super.init(jsBase: "new anychart.core.polar.series.Area()")
        }
