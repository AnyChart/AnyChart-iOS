 ...
 extension anychart.core.stock.scrollerseries {
    public class DiscreteBase: JsObject {
        ...
        public static func instantiate() -> DiscreteBase {
            return DiscreteBase(jsChart: "new anychart.core.stock.scrollerSeries.DiscreteBase()")
        }
     ...
     */
    public func allowPointSettings(enabled: Bool) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.stock.scrollerseries.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func height(height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func left(left: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func normal(settings: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func pointWidth(width: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func right(right: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func selected(settings: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func top(top: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func width(width: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func yScale(settings: anychart.scales.ScatterBase) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for the Y-scale.
     */
    public func yScale(settings: anychart.enums.ScaleTypes) -> anychart.core.stock.scrollerseries.DiscreteBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func labels(settings: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func maxPointWidth(width: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func minLabels(settings: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func minPointLength(length: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func rendering(settings: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func seriesType(type: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.stock.scrollerseries.DiscreteBase {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.stock.scrollerseries.DiscreteBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.stock.scrollerseries.DiscreteBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.stock.scrollerseries.DiscreteBase {
