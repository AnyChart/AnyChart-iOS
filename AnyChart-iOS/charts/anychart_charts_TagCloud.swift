 ...
 extension anychart.charts {
    public class TagCloud: JsObject {
        ...
        public static func instantiate() -> TagCloud {
            return TagCloud(jsChart: "new anychart.charts.TagCloud()")
        }
    ...
    public func anglesCount(count: Double) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".anglesCount(%s);", count))
...
<b>Note:</b> All data is words values.
     */
    public func data(data: anychart.data.View, settings: anychart.enums.TextParsingMode) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (settings != nil) ? settings.getJsBase() : "null"))
...
<b>Note:</b> All data is words values.
     */
    public func data(data: anychart.data.View, settings: anychart.data.TextParsingSettings) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (settings != nil) ? settings.getJsBase() : "null"))
...
<b>Note:</b> All data is words values.
     */
    public func data(data: anychart.data.Set, settings: String) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: settings)))
...
<b>Note:</b> All data is words values.
     */
    public func data(data: [String], settings: anychart.enums.TextParsingMode) -> anychart.charts.TagCloud {
...
<b>Note:</b> All data is words values.
     */
    public func data(data: [String], settings: anychart.data.TextParsingSettings) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: data), (settings != nil) ? settings.getJsBase() : "null"))
...
<b>Note:</b> All data is words values.
     */
    public func data(data: anychart.data.DataSettings, settings: String) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: settings)))
...
<b>Note:</b> All data is words values.
     */
    public func data(data: String, settings: anychart.enums.TextParsingMode) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.wrapQuotes(value: data), (settings != nil) ? settings.getJsBase() : "null"))
...
<b>Note:</b> All data is words values.
    ...
    public func fromAngle(angle: Double) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".fromAngle(%s);", angle))
...
<b>Note:</b> Works only after {@link anychart.charts.TagCloud#draw} is called.
    ...
    public func textSpacing(spacing: Double) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".textSpacing(%s);", spacing))
    ...
    public func toAngle(angle: Double) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".toAngle(%s);", angle))
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: anychart.graphics.vector.Fill) -> anychart.charts.TagCloud {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.TagCloud {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.TagCloud {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.TagCloud {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.TagCloud {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
