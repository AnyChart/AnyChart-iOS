 ...
 */
 extension anychart.core.cartesian.series {
    public class Spline: anychart.core.cartesian.series.ContinuousBase {
        ...
        public override init() {
            //return Spline(jsBase: "new anychart.core.cartesian.series.Spline()")
            super.init(jsBase: "new anychart.core.cartesian.series.Spline()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "spline\(JsObject.variableIndex)"
