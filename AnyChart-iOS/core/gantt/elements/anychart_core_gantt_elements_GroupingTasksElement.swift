 ...
 */
 extension anychart.core.gantt.elements {
    public class GroupingTasksElement: JsObject {

        override init() {

        }

        public static func instantiate() -> GroupingTasksElement {
            return GroupingTasksElement(jsChart: "new anychart.core.gantt.elements.GroupingTasksElement()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "groupingTasksElement\(JsObject.variableIndex)"
     ...
     */
    public func anchor(anchor: String) -> anychart.core.gantt.elements.GroupingTasksElement {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".anchor(%s);", JsObject.wrapQuotes(value: anchor)))
    ...
    public func edit() -> anychart.core.gantt.edit.ElementEdit {
        return anychart.core.gantt.edit.ElementEdit(jsChart: jsBase + ".edit()")
    }
    /**
     * Setter for live edit settings.
{docs:Gantt_Chart/Live_Edit_UI_and_API}Learn more about Live editing.{docs}
     */
    public func edit(settings: String) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: [String]) -> anychart.core.gantt.elements.GroupingTasksElement {
     ...
     */
    public func fill(color: String, opacity: Double) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.core.gantt.elements.GroupingTasksElement {
     ...
     */
    public func height(height: String) -> anychart.core.gantt.elements.GroupingTasksElement {
     ...
     */
    public func labels(settings: String) -> anychart.core.gantt.elements.GroupingTasksElement {
     ...
     */
    public func normal(settings: String) -> anychart.core.gantt.elements.GroupingTasksElement {
    ...
    public func offset(offset: String) -> anychart.core.ui.Timeline {
        return anychart.core.ui.Timeline(jsChart: String(format: jsBase + ".offset(%s)", JsObject.wrapQuotes(value: offset)))
    }
    /**
    ...
    public func position(position: String) -> anychart.core.ui.Timeline {
        return anychart.core.ui.Timeline(jsChart: String(format: jsBase + ".position(%s)", JsObject.wrapQuotes(value: position)))
    }
    /**
     * Getter for the grouping task progress.
     */
    public func progress() -> anychart.core.gantt.elements.ProgressElement {
        return anychart.core.gantt.elements.ProgressElement(jsChart: jsBase + ".progress()")
    }
    /**
    ...
    public func progress(settings: String) -> anychart.core.gantt.elements.GroupingTasksElement {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".progress(%s);", JsObject.wrapQuotes(value: settings)))
    ...
    public func rendering() -> anychart.core.gantt.rendering.Settings {
        return anychart.core.gantt.rendering.Settings(jsChart: jsBase + ".rendering()")
    }
    /**
     * Setter for rendering settings.
     */
    public func rendering(settings: String) -> anychart.core.gantt.elements.GroupingTasksElement {
     ...
     */
    public func selected(settings: String) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gantt.elements.GroupingTasksElement {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gantt.elements.GroupingTasksElement {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gantt.elements.GroupingTasksElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gantt.elements.GroupingTasksElement {
     ...
     */
    public func stroke(settings: String) -> anychart.core.gantt.elements.GroupingTasksElement {
