 ...
 */
 extension anychart.core.cartesian.series {
    public class StepArea: anychart.core.cartesian.series.ContinuousBase {
        ...
        public override init() {
            //return StepArea(jsBase: "new anychart.core.cartesian.series.StepArea()")
            super.init(jsBase: "new anychart.core.cartesian.series.StepArea()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "stepArea\(JsObject.variableIndex)"
