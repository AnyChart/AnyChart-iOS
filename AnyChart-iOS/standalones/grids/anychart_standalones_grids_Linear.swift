 ...
 extension anychart.standalones.grids {
    public class Linear: JsObject {
        ...
        public static func instantiate() -> Linear {
            return Linear(jsChart: "new anychart.standalones.grids.Linear()")
        }
     ...
     */
    public func axis(axis: anychart.core.axes.Linear) -> anychart.standalones.grids.Linear {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.standalones.grids.Linear {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.standalones.grids.Linear {
     ...
     */
    public func drawFirstLine(enabled: Bool) -> anychart.standalones.grids.Linear {
     ...
     */
    public func drawLastLine(enabled: Bool) -> anychart.standalones.grids.Linear {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: [String]) -> anychart.standalones.grids.Linear {
     ...
     */
    public func fill(color: String, opacity: Double) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.standalones.grids.Linear {
...
Layout is define by {@link anychart.core.grids.Linear#layout} method.
     ...
     */
    public func isMinor(enabled: Bool) -> anychart.standalones.grids.Linear {
     ...
     */
    public func palette(settings: anychart.palettes.RangeColors) -> anychart.standalones.grids.Linear {
     ...
     * Setter for the grid colors palette.
     */
    public func palette(settings: String) -> anychart.standalones.grids.Linear {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.standalones.grids.Linear {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.standalones.grids.Linear {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.standalones.grids.Linear {
     ...
     */
    public func scale(settings: String) -> anychart.standalones.grids.Linear {
     ...
     * Setter for the grid scale.
     */
    public func scale(settings: anychart.scales.Base) -> anychart.standalones.grids.Linear {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: anychart.graphics.vector.StrokeLineCap) -> anychart.standalones.grids.Linear {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", (lineCap != nil) ? lineCap.getJsBase() : "null"))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: anychart.graphics.vector.StrokeLineCap) -> anychart.standalones.grids.Linear {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", JsObject.wrapQuotes(value: color), thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", (lineCap != nil) ? lineCap.getJsBase() : "null"))
     ...
     */
    public func stroke(settings: String) -> anychart.standalones.grids.Linear {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.standalones.grids.Linear {
