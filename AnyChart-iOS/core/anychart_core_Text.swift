 ...
 extension anychart.core {
    public class Text: JsObject {
        ...
        public static func instantiate() -> Text {
            return Text(jsChart: "new anychart.core.Text()")
        }
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.Text {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     ...
     */
    public func textSettings(objectWithSettings: String) -> anychart.core.Text {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.Text {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.Text {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.Text {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.Text {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.Text {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.Text {
