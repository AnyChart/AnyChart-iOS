 ...
 extension anychart.core.stock.indicators {
    public class CCI: JsObject {
        ...
        public override init() {
            super.init()
            //return CCI(jsBase: "new anychart.core.stock.indicators.CCI()")
            //super.init(jsBase: "new anychart.core.stock.indicators.CCI()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "cCI\(JsObject.variableIndex)"
            APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: self.jsBase + " = " + jsBase + ";")
        }

        public func instantiate() -> anychart.core.stock.indicators.CCI {
            return anychart.core.stock.indicators.CCI(jsBase: "new anychart.core.stock.indicators.cci()")
        }
     ...
     * Setter for the indicator series type.
     */
    public func series(type: String) -> anychart.core.stock.indicators.CCI {
