 ...
 extension anychart.core.waterfall.series {
    public class Waterfall: JsObject {
        ...
        public static func instantiate() -> Waterfall {
            return Waterfall(jsChart: "new anychart.core.waterfall.series.Waterfall()")
        }
     ...
     */
    public func a11y(value: Bool) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.waterfall.series.Waterfall {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func clip(value: Bool) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.waterfall.series.Waterfall {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (value != nil) ? value.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: anychart.data.Set, csvSettings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.waterfall.series.Waterfall {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: value), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: String, csvSettings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.waterfall.series.Waterfall {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func height(height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Hovers points.
     */
    public func hover() -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func hover(index: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func hover(indexes: [Double]) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func hovered(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func id(id: String) -> anychart.core.waterfall.series.Waterfall {
...
Set it to null to reset to the default. {docs:Basic_Charts/Vertical/Overview}Learn more about Vertical chart.{docs}
     */
    public func isVertical(enabled: Bool) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func labels(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func left(left: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func legendItem(value: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func markers(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func maxLabels(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func maxPointWidth(width: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func meta(object: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func meta(key: String, value: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func minLabels(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func minPointLength(length: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func name(value: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func normal(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func pointWidth(width: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func rendering(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func right(right: Double) -> anychart.core.waterfall.series.Waterfall {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     ...
     * 
     */
    public func select(index: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func select(indexes: [Double]) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func selected(settings: String) -> anychart.core.waterfall.series.Waterfall {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public func selectionMode(value: anychart.enums.SelectionMode) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func seriesType(type: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     * 
     */
    public func tooltip(value: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func top(top: Double) -> anychart.core.waterfall.series.Waterfall {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public func unhover(indexOrIndexes: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func unselect() -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func unselect(index: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func unselect(indexes: [Double]) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func width(width: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func xPointPosition(position: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func xScale(settings: anychart.scales.Base) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for the series X scale.
     */
    public func xScale(settings: anychart.enums.ScaleTypes) -> anychart.core.waterfall.series.Waterfall {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".xScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func yScale(settings: anychart.scales.Base) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for the series Y scale.
     */
    public func yScale(settings: anychart.enums.ScaleTypes) -> anychart.core.waterfall.series.Waterfall {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScale(%s);", (settings != nil) ? settings.getJsBase() : "null"))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func error(settings: String) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for the series error.
     */
    public func error(settings: Double) -> anychart.core.waterfall.series.Waterfall {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.waterfall.series.Waterfall {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.waterfall.series.Waterfall {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.waterfall.series.Waterfall {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.waterfall.series.Waterfall {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.waterfall.series.Waterfall {
