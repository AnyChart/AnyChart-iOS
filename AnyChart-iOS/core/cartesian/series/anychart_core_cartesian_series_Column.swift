 ...
 */
 extension anychart.core.cartesian.series {
    public class Column: anychart.core.cartesian.series.WidthBased {
        ...
        public override init() {
            //return Column(jsBase: "new anychart.core.cartesian.series.Column()")
            super.init(jsBase: "new anychart.core.cartesian.series.Column()")
        }
