 ...
 extension anychart.graphics.vector {
    public class Layer: JsObject {
        ...
        public static func instantiate() -> Layer {
            return Layer(jsChart: "new anychart.graphics.vector.Layer()")
        }
...
<img src='/si/8.4.0/anychart.graphics.vector.Layer.addChildAt.png' width='276' height='130'/>
     ...
     */
    public func appendTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.Layer {
     ...
     */
    public func attr(key: String, value: String) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.Circle}
     ...
     */
    public func clip(value: anychart.graphics.math.Rect) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.primitives#cross}
     ...
     */
    public func cursor(value: anychart.graphics.vector.Cursor) -> anychart.graphics.vector.Layer {
     ...
     */
    public func desc(value: String) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.primitives#diamond}
     ...
     */
    public func disablePointerEvents(value: Bool) -> anychart.graphics.vector.Layer {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public func disableStrokeScaling(value: Bool) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.primitives#donut}
     ...
     */
    public func drag(value: Bool) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.primitives#hLine}
     ...
     */
    public func id(id: String) -> anychart.graphics.vector.Layer {
...
You have to take care of used objects yourself.
     ...
     */
    public func parent(parent: anychart.graphics.vector.Layer) -> anychart.graphics.vector.Layer {
...
You have to take care of used objects yourself.
     ...
     */
    public func remove() -> anychart.graphics.vector.Layer {
...
<b>Note:</b> this method doesn't remove element, it just breaks the link between the element and the layer.<br/>
     ...
     */
    public func rotate(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Layer {
     ...
     */
    public func rotateByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.primitives#roundedRect}
     ...
     */
    public func scale(sx: Double, sy: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Layer {
     ...
     */
    public func scaleByAnchor(sx: Double, sy: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Layer {
     ...
     */
    public func setPosition(x: Double, y: Double) -> anychart.graphics.vector.Layer {
     ...
     */
    public func setRotation(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Layer {
     ...
     * Rotates a shape around the given anchor.
     */
    public func setRotationByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Layer {
     ...
     */
    public func setTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.primitives#star7}
     ...
     */
    public func title(value: String) -> anychart.graphics.vector.Layer {
     ...
     */
    public func translate(tx: Double, ty: Double) -> anychart.graphics.vector.Layer {
...
Read more at {@link anychart.graphics.vector.primitives#vLine}
     ...
     */
    public func visible(isVisible: Bool) -> anychart.graphics.vector.Layer {
     ...
     */
    public func zIndex(value: Double) -> anychart.graphics.vector.Layer {
