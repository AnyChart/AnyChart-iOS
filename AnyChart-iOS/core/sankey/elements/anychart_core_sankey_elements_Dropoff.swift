 ...
 */
 extension anychart.core.sankey.elements {
    public class Dropoff: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> Dropoff {
            return Dropoff(jsChart: "new anychart.core.sankey.elements.Dropoff()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "dropoff\(JsObject.variableIndex)"
