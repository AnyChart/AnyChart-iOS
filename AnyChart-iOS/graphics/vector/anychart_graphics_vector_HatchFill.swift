 ...
 */
 extension anychart.graphics.vector {
    public class HatchFill: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> HatchFill {
            return HatchFill(jsChart: "new anychart.graphics.vector.HatchFill()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "hatchFill\(JsObject.variableIndex)"
