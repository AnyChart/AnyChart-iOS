 ...
 */
 extension anychart.charts {
    public class Scatter: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> Scatter {
            return Scatter(jsChart: "new anychart.charts.Scatter()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "scatter\(JsObject.variableIndex)"
     ...
     */
    public func a11y(settings: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func animation(settings: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func animation(enabled: Bool, duration: Double) -> anychart.charts.Scatter {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public func autoRedraw(enabled: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func background(settings: String) -> anychart.charts.Scatter {
...
The baseline is the line relative to which the series with the negative or positive value is drawn and painted over.
     ...
     */
    public func bottom(bottom: Double) -> anychart.charts.Scatter {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.charts.Scatter {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.charts.Scatter {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.charts.Scatter {
    ...
    public func bubble(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Bubble {
        return anychart.core.scatter.series.Bubble(jsChart: String(format: jsBase + ".bubble(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Bubble series.
     */
    ...
    public func bubble(data: anychart.data.Set, csvSettings: String) -> anychart.core.scatter.series.Bubble {
        return anychart.core.scatter.series.Bubble(jsChart: String(format: jsBase + ".bubble(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Bubble series.
     */
    public func bubble(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Bubble {
        return anychart.core.scatter.series.Bubble(jsChart: String(format: jsBase + ".bubble(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Bubble series.
     */
    ...
    public func bubble(data: String, csvSettings: String) -> anychart.core.scatter.series.Bubble {
        return anychart.core.scatter.series.Bubble(jsChart: String(format: jsBase + ".bubble(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Stops current marquee action if any.
     */
    public func cancelMarquee() -> anychart.charts.Scatter {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.charts.Scatter {
     ...
     * Setter for the element's container.
     */
    public func container(element: String) -> anychart.charts.Scatter {
     ...
     */
    public func contextMenu(settings: String) -> anychart.charts.Scatter {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public func credits(value: String) -> anychart.charts.Scatter {
    ...
    public func crossing() -> anychart.core.utils.Crossing {
        return anychart.core.utils.Crossing(jsChart: jsBase + ".crossing()")
    }
    /**
     * Setter for crossing settings.
     */
    public func crossing(settings: String) -> anychart.charts.Scatter {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".crossing(%s);", JsObject.wrapQuotes(value: settings)))
...
The data area is drawn along the data bounds.
    ...
    public func defaultSeriesType(type: String) -> anychart.charts.Scatter {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".defaultSeriesType(%s);", JsObject.wrapQuotes(value: type)))
     ...
     */
    public func draw(async: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func exports(settings: String) -> anychart.charts.Scatter {
     ...
     */
    public func fullScreen(enabled: Bool) -> anychart.charts.Scatter {
...
<b>Note:</b> Works only after {@link anychart.charts.Scatter#draw} is called.
    ...
    public func getSeries(id: Double) -> anychart.core.scatter.series.Base {
        return anychart.core.scatter.series.Base(jsChart: String(format: jsBase + ".getSeries(%s)", id))
    }
    /**
     * Gets series by its index.
     */
    public func getSeriesAt(index: Double) -> anychart.core.scatter.series.Base {
        return anychart.core.scatter.series.Base(jsChart: String(format: jsBase + ".getSeriesAt(%s)", index))
    }
    /**
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public func height(height: Double) -> anychart.charts.Scatter {
     ...
     * Setter for chart id.
     */
    public func id(id: String) -> anychart.charts.Scatter {
     ...
     */
    public func interactivity(settings: String) -> anychart.charts.Scatter {
     ...
     */
    public func label(settings: Bool) -> anychart.charts.Scatter {
     ...
     * Setter for the chart label.
     */
    public func label(index: String, settings: Bool) -> anychart.charts.Scatter {
     ...
     * Setter for the chart label.
     */
    public func label(index: Double, settings: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func left(left: Double) -> anychart.charts.Scatter {
     ...
     */
    public func legend(settings: String) -> anychart.charts.Scatter {
    ...
    public func line(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Line {
        return anychart.core.scatter.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Line series.
     */
    ...
    public func line(data: anychart.data.Set, csvSettings: String) -> anychart.core.scatter.series.Line {
        return anychart.core.scatter.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Line series.
     */
    public func line(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Line {
        return anychart.core.scatter.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Line series.
     */
    ...
    public func line(data: String, csvSettings: String) -> anychart.core.scatter.series.Line {
        return anychart.core.scatter.series.Line(jsChart: String(format: jsBase + ".line(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public func margin(margin: [Double]) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public func margin(margin: String) -> anychart.charts.Scatter {
     ...
     */
    public func margin(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.Scatter {
    ...
    public func marker(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Marker {
        return anychart.core.scatter.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Marker series.
     */
    ...
    public func marker(data: anychart.data.Set, csvSettings: String) -> anychart.core.scatter.series.Marker {
        return anychart.core.scatter.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", (data != nil) ? data.getJsBase() : "null", JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     * Adds Marker series.
     */
    public func marker(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Marker {
        return anychart.core.scatter.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
    }
    /**
     * Adds Marker series.
     */
    ...
    public func marker(data: String, csvSettings: String) -> anychart.core.scatter.series.Marker {
        return anychart.core.scatter.series.Marker(jsChart: String(format: jsBase + ".marker(%s, %s)", JsObject.wrapQuotes(value: data), JsObject.wrapQuotes(value: csvSettings)))
    }
    /**
     ...
     */
    public func maxHeight(height: Double) -> anychart.charts.Scatter {
     ...
     */
    public func maxWidth(width: Double) -> anychart.charts.Scatter {
    ...
    public func minBubbleSize(value: Double) -> anychart.charts.Scatter {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".minBubbleSize(%s);", value))
     ...
     */
    public func minHeight(height: Double) -> anychart.charts.Scatter {
     ...
     */
    public func minWidth(width: Double) -> anychart.charts.Scatter {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public func noData(settings: String) -> anychart.charts.Scatter {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public func padding(padding: [Double]) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public func padding(padding: String) -> anychart.charts.Scatter {
     ...
     */
    public func padding(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.Scatter {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.Scatter {
...
<b>Note</b>: You can use predefined palettes from {@link anychart.palettes}.
    ...
    public func quarters() -> anychart.core.utils.QuarterSettings {
        return anychart.core.utils.QuarterSettings(jsChart: jsBase + ".quarters()")
    }
    /**
     * Setter for quarter settings.
     */
    public func quarters(settings: String) -> anychart.charts.Scatter {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".quarters(%s);", JsObject.wrapQuotes(value: settings)))
     ...
     */
    public func right(right: Double) -> anychart.charts.Scatter {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: anychart.graphics.vector.Fill) -> anychart.charts.Scatter {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: [String]) -> anychart.charts.Scatter {
     ...
     */
    public func selectMarqueeFill(color: String, opacity: Double) -> anychart.charts.Scatter {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.charts.Scatter {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.charts.Scatter {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.charts.Scatter {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.charts.Scatter {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.Scatter {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Scatter {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Scatter {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Scatter {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Scatter {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Scatter {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Scatter {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public func startSelectMarquee(repeat1: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func title(settings: Bool) -> anychart.charts.Scatter {
     ...
     */
    public func tooltip(settings: String) -> anychart.charts.Scatter {
     ...
     */
    public func top(top: Double) -> anychart.charts.Scatter {
     ...
     */
    public func width(width: Double) -> anychart.charts.Scatter {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.charts.Scatter {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.charts.Scatter {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.charts.Scatter {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.charts.Scatter {
