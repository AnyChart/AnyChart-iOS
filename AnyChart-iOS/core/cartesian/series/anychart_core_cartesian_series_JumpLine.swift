 ...
 */
 extension anychart.core.cartesian.series {
    public class JumpLine: anychart.core.cartesian.series.WidthBased {
        ...
        public override init() {
            //return JumpLine(jsBase: "new anychart.core.cartesian.series.JumpLine()")
            super.init(jsBase: "new anychart.core.cartesian.series.JumpLine()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "jumpLine\(JsObject.variableIndex)"
