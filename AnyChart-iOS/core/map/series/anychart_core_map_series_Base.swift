 ...
 extension anychart.core.map.series {
    public class Base: JsObject {
        ...
        public static func instantiate() -> Base {
            return Base(jsChart: "new anychart.core.map.series.Base()")
        }
     ...
     */
    public func a11y(value: Bool) -> anychart.core.map.series.Base {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.map.series.Base {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.map.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.map.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.map.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.map.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.map.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.map.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.map.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.map.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func color(color: String) -> anychart.core.map.series.Base {
     ...
     */
    public func data(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.map.series.Base {
     ...
     * Setter for series mapping.
     */
    public func data(data: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.map.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for series mapping.
     */
    public func data(data: anychart.data.Set, csvSettings: String) -> anychart.core.map.series.Base {
     ...
     * Setter for series mapping.
     */
    public func data(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.map.series.Base {
     ...
     * Setter for series mapping.
     */
    public func data(data: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.map.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for series mapping.
     */
    public func data(data: String, csvSettings: String) -> anychart.core.map.series.Base {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.map.series.Base {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.core.map.series.Base {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.core.map.series.Base {
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
     ...
     */
    public func height(height: Double) -> anychart.core.map.series.Base {
     ...
     * Hovers points.
     */
    public func hover() -> anychart.core.map.series.Base {
     ...
     */
    public func hover(index: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func hover(indexes: [Double]) -> anychart.core.map.series.Base {
     ...
     */
    public func hovered(settings: String) -> anychart.core.map.series.Base {
     ...
     */
    public func id(id: String) -> anychart.core.map.series.Base {
     ...
     */
    public func labels(settings: String) -> anychart.core.map.series.Base {
     ...
     */
    public func left(left: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func legendItem(settings: String) -> anychart.core.map.series.Base {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func meta(object: String, value: String) -> anychart.core.map.series.Base {
     ...
     */
    public func meta(key: String, value: String) -> anychart.core.map.series.Base {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func name(name: String) -> anychart.core.map.series.Base {
     ...
     */
    public func normal(settings: String) -> anychart.core.map.series.Base {
     ...
     */
    public func right(right: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func select(index: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func select(indexes: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func selected(settings: String) -> anychart.core.map.series.Base {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public func selectionMode(value: anychart.enums.SelectionMode) -> anychart.core.map.series.Base {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.map.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.map.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     */
    public func tooltip(settings: String) -> anychart.core.map.series.Base {
     ...
     */
    public func top(top: Double) -> anychart.core.map.series.Base {
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     ...
     */
    public func unhover(indexOrIndexes: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func unselect() -> anychart.core.map.series.Base {
     ...
     */
    public func unselect(index: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func unselect(indexes: [Double]) -> anychart.core.map.series.Base {
     ...
     */
    public func width(width: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.map.series.Base {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.map.series.Base {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.map.series.Base {
     ...
     */
    public func markers(value: String) -> anychart.core.map.series.Base {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.map.series.Base {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.map.series.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.map.series.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.map.series.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.map.series.Base {
