 ...
 */
 extension anychart.core.polar.series {
    public class Polyline: anychart.core.polar.series.ContinuousBase {
        ...
        public override init() {
            //return Polyline(jsBase: "new anychart.core.polar.series.Polyline()")
            super.init(jsBase: "new anychart.core.polar.series.Polyline()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "polyline\(JsObject.variableIndex)"
