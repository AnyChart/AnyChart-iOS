 ...
 extension anychart.standalones.axismarkers {
    public class Range: JsObject {
        ...
        public static func instantiate() -> Range {
            return Range(jsChart: "new anychart.standalones.axisMarkers.Range()")
        }
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.standalones.axismarkers.Range {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.standalones.axismarkers.Range {
