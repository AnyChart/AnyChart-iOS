 ...
 extension anychart.graphics.vector {
    public class Ellipse: JsObject {
        ...
        public static func instantiate() -> Ellipse {
            return Ellipse(jsChart: "new anychart.graphics.vector.Ellipse()")
        }
     ...
     */
    public func appendTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func attr(key: String, value: String) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func clip(value: anychart.graphics.math.Rect) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func cursor(value: anychart.graphics.vector.Cursor) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func desc(value: String) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func disablePointerEvents(value: Bool) -> anychart.graphics.vector.Ellipse {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public func disableStrokeScaling(value: Bool) -> anychart.graphics.vector.Ellipse {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public func drag(value: Bool) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func fill(color: String, opacity: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.graphics.vector.Ellipse {
     ...
     * Linear gradient fill.
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.graphics.vector.Ellipse {
     ...
     * Linear gradient fill.
     */
    public func fill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.graphics.vector.Ellipse {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public func id(id: String) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func parent(parent: anychart.graphics.vector.Layer) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func remove() -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func rotate(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func rotateByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func scale(sx: Double, sy: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func scaleByAnchor(sx: Double, sy: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func setPosition(x: Double, y: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func setRotation(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Ellipse {
     ...
     * Rotates a shape around the given anchor.
     */
    public func setRotationByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func setTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func stroke(value: anychart.graphics.vector.Stroke) -> anychart.graphics.vector.Ellipse {
     ...
     * Sets a stroke using one parameter.
     */
    public func stroke(value: String) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.graphics.vector.Ellipse {
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.graphics.vector.Ellipse {
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.graphics.vector.Ellipse {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.graphics.vector.Ellipse {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.graphics.vector.Ellipse {
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func strokeThickness(thickness: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func title(value: String) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func translate(tx: Double, ty: Double) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func visible(isVisible: Bool) -> anychart.graphics.vector.Ellipse {
     ...
     */
    public func zIndex(value: Double) -> anychart.graphics.vector.Ellipse {
