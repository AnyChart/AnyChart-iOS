 ...
 */
 extension anychart.core.gantt.elements {
    public class BaselinesElement: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> BaselinesElement {
            return BaselinesElement(jsChart: "new anychart.core.gantt.elements.BaselinesElement()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "baselinesElement\(JsObject.variableIndex)"
     ...
     */
    public func above()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".above();")
    }
    /**
     * Setter for the 'above' flag.
     */
    public func above(enabled: Bool) -> anychart.core.gantt.elements.BaselinesElement {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".above(%s);", enabled))
     ...
     */
    public func anchor(anchor: String) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Gantt_Chart/Live_Edit_UI_and_API}Learn more about Live editing.{docs}
     */
    public func edit(settings: String) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: [String]) -> anychart.core.gantt.elements.BaselinesElement {
     ...
     */
    public func fill(color: String, opacity: Double) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.core.gantt.elements.BaselinesElement {
     ...
     */
    public func height(height: String) -> anychart.core.gantt.elements.BaselinesElement {
     ...
     */
    public func labels(settings: String) -> anychart.core.gantt.elements.BaselinesElement {
     ...
     */
    public func normal(settings: String) -> anychart.core.gantt.elements.BaselinesElement {
     ...
     */
    public func rendering(settings: String) -> anychart.core.gantt.elements.BaselinesElement {
     ...
     */
    public func selected(settings: String) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gantt.elements.BaselinesElement {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gantt.elements.BaselinesElement {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gantt.elements.BaselinesElement {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gantt.elements.BaselinesElement {
     ...
     */
    public func stroke(settings: String) -> anychart.core.gantt.elements.BaselinesElement {
