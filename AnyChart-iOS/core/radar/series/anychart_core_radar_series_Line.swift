 ...
 */
 extension anychart.core.radar.series {
    public class Line: anychart.core.radar.series.ContinuousBase {
        ...
        public override init() {
            //return Line(jsBase: "new anychart.core.radar.series.Line()")
            super.init(jsBase: "new anychart.core.radar.series.Line()")
        }
