 ...
 */
 extension anychart.charts {
    public class LinearGauge: JsObject {

        override init() {

        }

        public static func instantiate() -> LinearGauge {
            return LinearGauge(jsChart: "new anychart.charts.LinearGauge()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "linearGauge\(JsObject.variableIndex)"
     ...
     */
    public func a11y(settings: Bool) -> anychart.charts.LinearGauge {
    ...
    public func addPointer(var_args: Double)  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".addPointer(%s);", var_args))
    }
    /**
     * Adds pointers to the gauge.
     */
     ...
     */
    public func animation(settings: Bool) -> anychart.charts.LinearGauge {
     ...
     */
    public func animation(enabled: Bool, duration: Double) -> anychart.charts.LinearGauge {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public func autoRedraw(enabled: Bool) -> anychart.charts.LinearGauge {
    ...
    public func axis(index: Double) -> anychart.core.axes.LinearGauge {
        return anychart.core.axes.LinearGauge(jsChart: String(format: jsBase + ".axis(%s)", index))
    }
    /**
     ...
     */
    public func background(settings: String) -> anychart.charts.LinearGauge {
    ...
    public func bar(dataIndex: Double) -> anychart.core.lineargauge.pointers.Bar {
        return anychart.core.lineargauge.pointers.Bar(jsChart: String(format: jsBase + ".bar(%s)", dataIndex))
    }
    /**
     ...
     */
    public func bottom(bottom: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.charts.LinearGauge {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func cancelMarquee() -> anychart.charts.LinearGauge {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.charts.LinearGauge {
     ...
     * Setter for the element's container.
     */
    public func container(element: String) -> anychart.charts.LinearGauge {
     ...
     */
    public func contextMenu(settings: String) -> anychart.charts.LinearGauge {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public func credits(value: String) -> anychart.charts.LinearGauge {
     ...
     */
    public func data(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.charts.LinearGauge {
     ...
     * Setter for the pointers mapping.
     */
    public func data(data: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for the pointers mapping.
     */
    public func data(data: anychart.data.Set, csvSettings: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the pointers mapping.
     */
    public func data(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.charts.LinearGauge {
     ...
     * Setter for the pointers mapping.
     */
    public func data(data: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for the pointers mapping.
     */
    public func data(data: String, csvSettings: String) -> anychart.charts.LinearGauge {
     ...
     */
    public func draw(async: Bool) -> anychart.charts.LinearGauge {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.charts.LinearGauge {
     ...
     */
    public func exports(settings: String) -> anychart.charts.LinearGauge {
     ...
     */
    public func fullScreen(enabled: Bool) -> anychart.charts.LinearGauge {
    ...
    public func getPointer(id: Double) -> anychart.core.lineargauge.pointers.Base {
        return anychart.core.lineargauge.pointers.Base(jsChart: String(format: jsBase + ".getPointer(%s)", id))
    }
    /**
     * Returns pointer by index.
     */
    public func getPointerAt(index: Double) -> anychart.core.lineargauge.pointers.Base {
        return anychart.core.lineargauge.pointers.Base(jsChart: String(format: jsBase + ".getPointerAt(%s)", index))
    }
    /**
    ...
    public func globalOffset()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".globalOffset();")
    }
    /**
     * Setter for the global offset of a linear gauge.
     */
    public func globalOffset(offset: String) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".globalOffset(%s);", JsObject.wrapQuotes(value: offset)))
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public func height(height: Double) -> anychart.charts.LinearGauge {
     ...
     * Setter for chart id.
     */
    public func id(id: String) -> anychart.charts.LinearGauge {
     ...
     */
    public func interactivity(settings: String) -> anychart.charts.LinearGauge {
    ...
    public func isVertical(value: Bool) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".isVertical(%s);", value))
     ...
     */
    public func label(settings: Bool) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart label.
     */
    public func label(index: String, settings: Bool) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart label.
     */
    public func label(index: Double, settings: Bool) -> anychart.charts.LinearGauge {
    ...
    public func led(dataIndex: Double) -> anychart.core.lineargauge.pointers.Led {
        return anychart.core.lineargauge.pointers.Led(jsChart: String(format: jsBase + ".led(%s)", dataIndex))
    }
    /**
     ...
     */
    public func left(left: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func legend(settings: String) -> anychart.charts.LinearGauge {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public func margin(margin: [Double]) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public func margin(margin: String) -> anychart.charts.LinearGauge {
     ...
     */
    public func margin(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.LinearGauge {
    ...
    public func marker(dataIndex: Double) -> anychart.core.lineargauge.pointers.Marker {
        return anychart.core.lineargauge.pointers.Marker(jsChart: String(format: jsBase + ".marker(%s)", dataIndex))
    }
    /**
     ...
     */
    public func maxHeight(height: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func maxWidth(width: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func minHeight(height: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func minWidth(width: Double) -> anychart.charts.LinearGauge {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public func noData(settings: String) -> anychart.charts.LinearGauge {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public func padding(padding: [Double]) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public func padding(padding: String) -> anychart.charts.LinearGauge {
     ...
     */
    public func padding(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.LinearGauge {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.LinearGauge {
    ...
    public func rangeBar(dataIndex: Double) -> anychart.core.lineargauge.pointers.RangeBar {
        return anychart.core.lineargauge.pointers.RangeBar(jsChart: String(format: jsBase + ".rangeBar(%s)", dataIndex))
    }
    /**
     ...
     */
    public func right(right: Double) -> anychart.charts.LinearGauge {
    ...
    public func scaleBar(index: Double) -> anychart.core.lineargauge.ScaleBar {
        return anychart.core.lineargauge.ScaleBar(jsChart: String(format: jsBase + ".scaleBar(%s)", index))
    }
    /**
     * Setter for the scale bar.
     */
    public func scaleBar(settings: String) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".scaleBar(%s);", JsObject.wrapQuotes(value: settings)))
    ...
    public func scaleBar(index: Double, settings: String) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".scaleBar(%s, %s);", index, JsObject.wrapQuotes(value: settings)))
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: anychart.graphics.vector.Fill) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: [String]) -> anychart.charts.LinearGauge {
     ...
     */
    public func selectMarqueeFill(color: String, opacity: Double) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.LinearGauge {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.LinearGauge {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.LinearGauge {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public func startSelectMarquee(repeat1: Bool) -> anychart.charts.LinearGauge {
    ...
    public func tank(dataIndex: Double) -> anychart.core.lineargauge.pointers.Tank {
        return anychart.core.lineargauge.pointers.Tank(jsChart: String(format: jsBase + ".tank(%s)", dataIndex))
    }
    /**
     * Adds Thermometer pointer.
     */
    public func thermometer(dataIndex: Double) -> anychart.core.lineargauge.pointers.Thermometer {
        return anychart.core.lineargauge.pointers.Thermometer(jsChart: String(format: jsBase + ".thermometer(%s)", dataIndex))
    }
    /**
     ...
     */
    public func title(settings: Bool) -> anychart.charts.LinearGauge {
     ...
     */
    public func top(top: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func width(width: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.charts.LinearGauge {
     ...
     */
    public func tooltip(settings: String) -> anychart.charts.LinearGauge {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.charts.LinearGauge {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.charts.LinearGauge {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.charts.LinearGauge {
