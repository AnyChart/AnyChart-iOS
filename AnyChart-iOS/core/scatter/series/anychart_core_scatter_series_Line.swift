 ...
 */
 extension anychart.core.scatter.series {
    public class Line: anychart.core.scatter.series.BaseWithMarkers {
        ...
        public override init() {
            //return Line(jsBase: "new anychart.core.scatter.series.Line()")
            super.init(jsBase: "new anychart.core.scatter.series.Line()")
        }
