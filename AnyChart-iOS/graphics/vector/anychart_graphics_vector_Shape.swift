 ...
 */
 extension anychart.graphics.vector {
    public class Shape: JsObject {

        override init() {

        }

        public static func instantiate() -> Shape {
            return Shape(jsChart: "new anychart.graphics.vector.Shape()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "shape\(JsObject.variableIndex)"
     ...
     */
    public func appendTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.Shape {
     ...
     */
    public func attr(key: String, value: String) -> anychart.graphics.vector.Shape {
     ...
     */
    public func clip(value: anychart.graphics.math.Rect) -> anychart.graphics.vector.Shape {
     ...
     */
    public func cursor(value: anychart.graphics.vector.Cursor) -> anychart.graphics.vector.Shape {
     ...
     */
    public func desc(value: String) -> anychart.graphics.vector.Shape {
     ...
     */
    public func disablePointerEvents(value: Bool) -> anychart.graphics.vector.Shape {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public func disableStrokeScaling(value: Bool) -> anychart.graphics.vector.Shape {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public func drag(value: Bool) -> anychart.graphics.vector.Shape {
     ...
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.graphics.vector.Shape {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public func id(id: String) -> anychart.graphics.vector.Shape {
     ...
     */
    public func parent(parent: anychart.graphics.vector.Layer) -> anychart.graphics.vector.Shape {
     ...
     */
    public func remove() -> anychart.graphics.vector.Shape {
     ...
     */
    public func rotate(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Shape {
     ...
     */
    public func rotateByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Shape {
     ...
     */
    public func scale(sx: Double, sy: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Shape {
     ...
     */
    public func scaleByAnchor(sx: Double, sy: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Shape {
     ...
     */
    public func setPosition(x: Double, y: Double) -> anychart.graphics.vector.Shape {
     ...
     */
    public func setRotation(degrees: Double, cx: Double, cy: Double) -> anychart.graphics.vector.Shape {
     ...
     * Rotates a shape around the given anchor.
     */
    public func setRotationByAnchor(degrees: Double, anchor: anychart.graphics.vector.Anchor) -> anychart.graphics.vector.Shape {
     ...
     */
    public func setTransformationMatrix(m00: Double, m10: Double, m01: Double, m11: Double, m02: Double, m12: Double) -> anychart.graphics.vector.Shape {
     ...
     */
    public func stroke(value: anychart.graphics.vector.Stroke) -> anychart.graphics.vector.Shape {
     ...
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.graphics.vector.Shape {
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.graphics.vector.Shape {
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.graphics.vector.Shape {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
     ...
     * Sets stroke settings using several parameter.
     */
    public func stroke(value: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.graphics.vector.Shape {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != nil) ? value.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
     ...
     */
    public func title(value: String) -> anychart.graphics.vector.Shape {
     ...
     */
    public func translate(tx: Double, ty: Double) -> anychart.graphics.vector.Shape {
     ...
     */
    public func visible(isVisible: Bool) -> anychart.graphics.vector.Shape {
     ...
     */
    public func zIndex(value: Double) -> anychart.graphics.vector.Shape {
