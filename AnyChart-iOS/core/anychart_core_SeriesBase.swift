 ...
 */
 extension anychart.core {
    public class SeriesBase: JsObject {

        override init() {

        }

        public static func instantiate() -> SeriesBase {
            return SeriesBase(jsChart: "new anychart.core.SeriesBase()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "seriesBase\(JsObject.variableIndex)"
     ...
     */
    public func data(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.SeriesBase {
     ...
     * Setter for series mapping.
     */
    public func data(data: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.SeriesBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for series mapping.
     */
    public func data(data: anychart.data.Set, csvSettings: String) -> anychart.core.SeriesBase {
     ...
     * Setter for series mapping.
     */
    public func data(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.SeriesBase {
     ...
     * Setter for series mapping.
     */
    public func data(data: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.SeriesBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for series mapping.
     */
    public func data(data: String, csvSettings: String) -> anychart.core.SeriesBase {
    ...
    public func normal(value: String) -> anychart.core.SeriesBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".normal(%s);", JsObject.wrapQuotes(value: value)))
    ...
    public func selected(value: String) -> anychart.core.SeriesBase {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selected(%s);", JsObject.wrapQuotes(value: value)))
