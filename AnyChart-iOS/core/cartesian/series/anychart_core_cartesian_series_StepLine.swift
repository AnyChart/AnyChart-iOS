 ...
 */
 extension anychart.core.cartesian.series {
    public class StepLine: anychart.core.cartesian.series.ContinuousBase {
        ...
        public override init() {
            //return StepLine(jsBase: "new anychart.core.cartesian.series.StepLine()")
            super.init(jsBase: "new anychart.core.cartesian.series.StepLine()")
        }
