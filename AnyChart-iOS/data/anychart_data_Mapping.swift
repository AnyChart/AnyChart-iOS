 ...
 */
 extension anychart.data {
    public class Mapping: JsObject {

        override init() {

        }

        public static func instantiate() -> Mapping {
            return Mapping(jsChart: "new anychart.data.Mapping()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "mapping\(JsObject.variableIndex)"
