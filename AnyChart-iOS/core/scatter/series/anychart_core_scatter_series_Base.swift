 ...
 extension anychart.core.scatter.series {
    public class Base: JsObject {
        ...
        public static func instantiate() -> Base {
            return Base(jsChart: "new anychart.core.scatter.series.Base()")
        }
     ...
     */
    public func a11y(value: Bool) -> anychart.core.scatter.series.Base {
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.scatter.series.Base {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.scatter.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.scatter.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.scatter.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.scatter.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.scatter.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.scatter.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.scatter.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.scatter.series.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.scatter.series.Base {
...
Clips visible part of a series by a rectangle (or chart).
     ...
     * 
     */
    public func color(value: String) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func data(value: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.core.scatter.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (value != nil) ? value.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: anychart.data.Set, csvSettings: String) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func data(value: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.core.scatter.series.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: value), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * 
     */
    public func data(value: String, csvSettings: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.scatter.series.Base {
     ...
     */
    public func height(height: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func hovered(settings: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func id(id: String) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func labels(value: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func left(left: Double) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func legendItem(value: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func meta(object: String) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func meta(key: String, value: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func name(value: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func normal(settings: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func right(right: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func select(index: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func select(indexes: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func selected(settings: String) -> anychart.core.scatter.series.Base {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public func selectionMode(value: anychart.enums.SelectionMode) -> anychart.core.scatter.series.Base {
     ...
     * 
     */
    public func tooltip(value: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func top(top: Double) -> anychart.core.scatter.series.Base {
...
<b>Note:</b> Works only after {@link anychart.charts.Scatter#draw} is called.
     ...
     */
    public func unhover(indexOrIndexes: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func unselect() -> anychart.core.scatter.series.Base {
     ...
     */
    public func unselect(index: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func width(width: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func colorScale(settings: anychart.scales.LinearColor) -> anychart.core.scatter.series.Base {
     ...
     * Setter for the color scale.
     */
    public func colorScale(settings: String) -> anychart.core.scatter.series.Base {
     ...
     * Hovers points.
     */
    public func hover() -> anychart.core.scatter.series.Base {
     ...
     */
    public func hover(index: Double) -> anychart.core.scatter.series.Base {
     ...
     */
    public func markers(value: String) -> anychart.core.scatter.series.Base {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.scatter.series.Base {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.scatter.series.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.scatter.series.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.scatter.series.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.scatter.series.Base {
