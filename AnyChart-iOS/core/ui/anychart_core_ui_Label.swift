 ...
 extension anychart.core.ui {
    public class Label: JsObject {
        ...
        public static func instantiate() -> Label {
            return Label(jsChart: "new anychart.core.ui.Label()")
        }
     ...
     */
    public func disablePointerEvents(enabled: Bool) -> anychart.core.ui.Label {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.ui.Label {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public func fontColor(color: String) -> anychart.core.ui.Label {
     ...
     */
    public func fontDecoration(value: anychart.graphics.vector.text.Decoration) -> anychart.core.ui.Label {
     ...
     */
    public func fontFamily(family: String) -> anychart.core.ui.Label {
     ...
     */
    public func fontOpacity(opacity: Double) -> anychart.core.ui.Label {
     ...
     */
    public func fontSize(size: String) -> anychart.core.ui.Label {
     ...
     */
    public func fontStyle(style: anychart.graphics.vector.text.FontStyle) -> anychart.core.ui.Label {
     ...
     */
    public func fontVariant(value: anychart.graphics.vector.text.FontVariant) -> anychart.core.ui.Label {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public func fontWeight(weight: String) -> anychart.core.ui.Label {
     ...
     */
    public func hAlign(align: anychart.graphics.vector.text.HAlign) -> anychart.core.ui.Label {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public func letterSpacing(spacing: String) -> anychart.core.ui.Label {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public func lineHeight(height: String) -> anychart.core.ui.Label {
...
Arrows show offsets layout.
     ...
     */
    public func selectable(enabled: Bool) -> anychart.core.ui.Label {
     ...
     */
    public func textDirection(direction: anychart.graphics.vector.text.Direction) -> anychart.core.ui.Label {
     ...
     */
    public func textIndent(indent: Double) -> anychart.core.ui.Label {
     ...
     */
    public func textOverflow(value: anychart.graphics.vector.text.TextOverflow) -> anychart.core.ui.Label {
     ...
     */
    public func textSettings(objectWithSettings: String) -> anychart.core.ui.Label {
     ...
     */
    public func textSettings(name: String, settings: String) -> anychart.core.ui.Label {
     ...
     * Setter for the text appearance settings.
     */
    public func textSettings(name: String, settings: Bool) -> anychart.core.ui.Label {
     ...
     */
    public func useHtml(enabled: Bool) -> anychart.core.ui.Label {
     ...
     */
    public func vAlign(align: anychart.graphics.vector.text.VAlign) -> anychart.core.ui.Label {
     ...
     */
    public func wordBreak(mode: anychart.enums.WordBreak) -> anychart.core.ui.Label {
     ...
     */
    public func wordWrap(mode: anychart.enums.WordWrap) -> anychart.core.ui.Label {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.ui.Label {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.ui.Label {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.ui.Label {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.ui.Label {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.ui.Label {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.ui.Label {
