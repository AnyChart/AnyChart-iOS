 ...
 extension anychart.core.stock.indicators {
    public class EMA: JsObject {
        ...
        public override init() {
            super.init()
            //return EMA(jsBase: "new anychart.core.stock.indicators.EMA()")
            //super.init(jsBase: "new anychart.core.stock.indicators.EMA()")
        }
        ...
        public override init(jsBase: String) {
            ...
            self.jsBase = "eMA\(JsObject.variableIndex)"
            APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: self.jsBase + " = " + jsBase + ";")
        }

        public func instantiate() -> anychart.core.stock.indicators.EMA {
            return anychart.core.stock.indicators.EMA(jsBase: "new anychart.core.stock.indicators.ema()")
        }
     ...
     * Setter for the indicator series type.
     */
    public func series(type: String) -> anychart.core.stock.indicators.EMA {
