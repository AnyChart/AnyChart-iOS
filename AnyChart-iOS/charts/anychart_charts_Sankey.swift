 ...
 */
 extension anychart.charts {
    public class Sankey: JsObject {

        override init() {

        }

        public static func instantiate() -> Sankey {
            return Sankey(jsChart: "new anychart.charts.Sankey()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "sankey\(JsObject.variableIndex)"
     ...
     */
    public func a11y(settings: Bool) -> anychart.charts.Sankey {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public func autoRedraw(enabled: Bool) -> anychart.charts.Sankey {
     ...
     */
    public func background(settings: String) -> anychart.charts.Sankey {
     ...
     */
    public func bottom(bottom: Double) -> anychart.charts.Sankey {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.charts.Sankey {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.charts.Sankey {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.charts.Sankey {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.charts.Sankey {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.charts.Sankey {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.charts.Sankey {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.charts.Sankey {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.charts.Sankey {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.charts.Sankey {
     ...
     */
    public func cancelMarquee() -> anychart.charts.Sankey {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.charts.Sankey {
     ...
     * Setter for the element's container.
     */
    public func container(element: String) -> anychart.charts.Sankey {
     ...
     */
    public func contextMenu(settings: String) -> anychart.charts.Sankey {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public func credits(value: String) -> anychart.charts.Sankey {
    ...
    public func curveFactor()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".curveFactor();")
    }
    /**
     * Setter for the curve factor of the flows.
     */
    public func curveFactor(padding: Double) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".curveFactor(%s);", padding))
     ...
     */
    public func data(data: anychart.data.View) -> anychart.charts.Sankey {
     ...
     * Setter for the chart data.
     */
    public func data(data: [String]) -> anychart.charts.Sankey {
     ...
     */
    public func data(csvString: String, csvSettings: anychart.enums.TextParsingMode) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.wrapQuotes(value: csvString), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     */
    public func draw(async: Bool) -> anychart.charts.Sankey {
    ...
    public func dropoff() -> anychart.core.sankey.elements.Dropoff {
        return anychart.core.sankey.elements.Dropoff(jsChart: jsBase + ".dropoff()")
    }
    /**
...
The dropoff element has null in the 'to' data field.
    ...
    public func dropoff(settings: String) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".dropoff(%s);", JsObject.wrapQuotes(value: settings)))
     ...
     */
    public func enabled(enabled: Bool) -> anychart.charts.Sankey {
     ...
     */
    public func exports(settings: String) -> anychart.charts.Sankey {
    ...
    public func flow() -> anychart.core.sankey.elements.Flow {
        return anychart.core.sankey.elements.Flow(jsChart: jsBase + ".flow()")
    }
    /**
...
The flow is the link between nodes.
    ...
    public func flow(settings: String) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".flow(%s);", JsObject.wrapQuotes(value: settings)))
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public func height(height: Double) -> anychart.charts.Sankey {
     ...
     */
    public func label(settings: Bool) -> anychart.charts.Sankey {
     ...
     * Setter for the chart label.
     */
    public func label(index: String, settings: Bool) -> anychart.charts.Sankey {
     ...
     * Setter for the chart label.
     */
    public func label(index: Double, settings: Bool) -> anychart.charts.Sankey {
     ...
     */
    public func left(left: Double) -> anychart.charts.Sankey {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public func margin(margin: [Double]) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public func margin(margin: String) -> anychart.charts.Sankey {
     ...
     */
    public func margin(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     */
    public func maxHeight(height: Double) -> anychart.charts.Sankey {
     ...
     */
    public func maxWidth(width: Double) -> anychart.charts.Sankey {
     ...
     */
    public func minHeight(height: Double) -> anychart.charts.Sankey {
     ...
     */
    public func minWidth(width: Double) -> anychart.charts.Sankey {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public func noData(settings: String) -> anychart.charts.Sankey {
    ...
    public func node() -> anychart.core.sankey.elements.Node {
        return anychart.core.sankey.elements.Node(jsChart: jsBase + ".node()")
    }
    /**
...
The node is a vertical bar between flows.
    ...
    public func node(settings: String) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".node(%s);", JsObject.wrapQuotes(value: settings)))
    ...
    public func nodePadding()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".nodePadding();")
    }
    /**
...
Node padding is the base distance between nodes.
    ...
    public func nodePadding(padding: Double) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".nodePadding(%s);", padding))
    ...
    public func nodeWidth()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".nodeWidth();")
    }
    /**
     * Setter for the nodes width.
     */
    public func nodeWidth(width: Double) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".nodeWidth(%s);", width))
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public func padding(padding: [Double]) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public func padding(padding: String) -> anychart.charts.Sankey {
     ...
     */
    public func padding(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.Sankey {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.Sankey {
     ...
     */
    public func right(right: Double) -> anychart.charts.Sankey {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: anychart.graphics.vector.Fill) -> anychart.charts.Sankey {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: [String]) -> anychart.charts.Sankey {
     ...
     */
    public func selectMarqueeFill(color: String, opacity: Double) -> anychart.charts.Sankey {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.charts.Sankey {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.charts.Sankey {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.charts.Sankey {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.charts.Sankey {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.Sankey {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Sankey {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Sankey {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Sankey {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.Sankey {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.Sankey {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public func startSelectMarquee(repeat1: Bool) -> anychart.charts.Sankey {
     ...
     */
    public func title(settings: Bool) -> anychart.charts.Sankey {
     ...
     */
    public func tooltip(settings: String) -> anychart.charts.Sankey {
     ...
     */
    public func top(top: Double) -> anychart.charts.Sankey {
     ...
     */
    public func width(width: Double) -> anychart.charts.Sankey {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.charts.Sankey {
     ...
     */
    public func animation(settings: Bool) -> anychart.charts.Sankey {
     ...
     */
    public func animation(enabled: Bool, duration: Double) -> anychart.charts.Sankey {
     ...
     */
    public func fullScreen(enabled: Bool) -> anychart.charts.Sankey {
     ...
     * Setter for chart id.
     */
    public func id(id: String) -> anychart.charts.Sankey {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.charts.Sankey {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.charts.Sankey {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.charts.Sankey {
