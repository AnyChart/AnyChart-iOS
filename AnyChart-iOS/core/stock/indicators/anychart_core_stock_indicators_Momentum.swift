 ...
 */
 extension anychart.core.stock.indicators {
    public class Momentum: JsObject {
        ...
        public static func instantiate() -> Momentum {
            return Momentum(jsChart: "new anychart.core.stock.indicators.Momentum()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "momentum\(JsObject.variableIndex)"
    ...
    public func series(type: anychart.enums.StockSeriesType) -> anychart.core.stock.indicators.MFI {
        return anychart.core.stock.indicators.MFI(jsChart: String(format: jsBase + ".series(%s)", (type != nil) ? type.getJsBase() : "null"))
    }
