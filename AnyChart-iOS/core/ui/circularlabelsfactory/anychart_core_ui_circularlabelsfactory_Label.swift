 ...
 extension anychart.core.ui.circularlabelsfactory {
    public class Label: JsObject {
        ...
        public static func instantiate() -> Label {
            return Label(jsChart: "new anychart.core.ui.CircularLabelsFactory.Label()")
        }
     ...
     */
    public func adjustFontSize(adjustByWidth: Bool, adjustByHeight: Bool) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func adjustFontSize(value: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for the adjusting font size by one parameter.
     */
    public func adjustFontSize(value: Bool) -> anychart.core.ui.circularlabelsfactory.Label {
    ...
    public func autoRotate()  {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: jsBase + ".autoRotate();")
    }
    /**
...
Auto rotates a label around an anchor.
     ...
     */
    public func background(settings: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func disablePointerEvents(enabled: Bool) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.ui.circularlabelsfactory.Label {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public func fontColor(color: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func fontDecoration(value: anychart.graphics.vector.text.Decoration) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func fontFamily(family: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func fontOpacity(opacity: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func fontSize(size: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func fontStyle(style: anychart.graphics.vector.text.FontStyle) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func fontVariant(value: anychart.graphics.vector.text.FontVariant) -> anychart.core.ui.circularlabelsfactory.Label {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public func fontWeight(weight: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func hAlign(align: anychart.graphics.vector.text.HAlign) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func height(height: Double) -> anychart.core.ui.circularlabelsfactory.Label {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public func letterSpacing(spacing: String) -> anychart.core.ui.circularlabelsfactory.Label {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public func lineHeight(height: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func maxFontSize(size: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func minFontSize(size: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func offsetX(offset: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func offsetY(offset: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding in pixels using a single value.
     */
    public func padding(padding: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func padding(value1: String, value2: String, value3: String, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding setting in pixels using a several value.
     */
    public func padding(value1: String, value2: String, value3: Double, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding setting in pixels using a several value.
     */
    public func padding(value1: String, value2: Double, value3: String, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding setting in pixels using a several value.
     */
    public func padding(value1: String, value2: Double, value3: Double, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding setting in pixels using a several value.
     */
    public func padding(value1: Double, value2: String, value3: String, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding setting in pixels using a several value.
     */
    public func padding(value1: Double, value2: String, value3: Double, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding setting in pixels using a several value.
     */
    public func padding(value1: Double, value2: Double, value3: String, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for label padding setting in pixels using a several value.
     */
    public func padding(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func position(position: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func rotation(angle: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func selectable(enabled: Bool) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func textDirection(direction: anychart.graphics.vector.text.Direction) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func textIndent(indent: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func textOverflow(value: anychart.graphics.vector.text.TextOverflow) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func textSettings(objectWithSettings: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func textSettings(name: String, settings: String) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for the text appearance settings.
     */
    public func textSettings(name: String, settings: Bool) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func useHtml(enabled: Bool) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func vAlign(align: anychart.graphics.vector.text.VAlign) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func width(width: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func wordBreak(mode: anychart.enums.WordBreak) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func wordWrap(mode: anychart.enums.WordWrap) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * 
     */
    public func draw() -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.ui.circularlabelsfactory.Label {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.ui.circularlabelsfactory.Label {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.ui.circularlabelsfactory.Label {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.ui.circularlabelsfactory.Label {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.ui.circularlabelsfactory.Label {
