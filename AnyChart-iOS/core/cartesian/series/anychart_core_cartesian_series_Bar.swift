 ...
 */
 extension anychart.core.cartesian.series {
    public class Bar: anychart.core.cartesian.series.WidthBased {
        ...
        public override init() {
            //return Bar(jsBase: "new anychart.core.cartesian.series.Bar()")
            super.init(jsBase: "new anychart.core.cartesian.series.Bar()")
        }
