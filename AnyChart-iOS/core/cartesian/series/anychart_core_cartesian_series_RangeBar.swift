 ...
 */
 extension anychart.core.cartesian.series {
    public class RangeBar: anychart.core.cartesian.series.WidthBased {
        ...
        public override init() {
            //return RangeBar(jsBase: "new anychart.core.cartesian.series.RangeBar()")
            super.init(jsBase: "new anychart.core.cartesian.series.RangeBar()")
        }
