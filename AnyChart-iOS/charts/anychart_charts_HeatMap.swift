 ...
 */
 extension anychart.charts {
    public class HeatMap: JsObject {

        override init() {

        }

        public static func instantiate() -> HeatMap {
            return HeatMap(jsChart: "new anychart.charts.HeatMap()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "heatMap\(JsObject.variableIndex)"
     ...
     */
    public func a11y(settings: Bool) -> anychart.charts.HeatMap {
     ...
     */
    public func animation(settings: Bool) -> anychart.charts.HeatMap {
     ...
     */
    public func animation(enabled: Bool, duration: Double) -> anychart.charts.HeatMap {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public func autoRedraw(enabled: Bool) -> anychart.charts.HeatMap {
     ...
     */
    public func background(settings: String) -> anychart.charts.HeatMap {
     ...
     */
    public func bottom(bottom: Double) -> anychart.charts.HeatMap {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.charts.HeatMap {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.charts.HeatMap {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.charts.HeatMap {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.charts.HeatMap {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.charts.HeatMap {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.charts.HeatMap {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.charts.HeatMap {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.charts.HeatMap {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.charts.HeatMap {
     ...
     */
    public func cancelMarquee() -> anychart.charts.HeatMap {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.charts.HeatMap {
     ...
     * Setter for the element's container.
     */
    public func container(element: String) -> anychart.charts.HeatMap {
     ...
     */
    public func contextMenu(settings: String) -> anychart.charts.HeatMap {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public func credits(value: String) -> anychart.charts.HeatMap {
     ...
     */
    public func data(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart data.
     */
    public func data(data: anychart.data.View, csvSettings: anychart.data.TextParsingSettings) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for the chart data.
     */
    public func data(data: anychart.data.Set, csvSettings: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart data.
     */
    public func data(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart data.
     */
    public func data(data: [String], csvSettings: anychart.data.TextParsingSettings) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", JsObject.arrayToStringWrapQuotes(array: data), (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for the chart data.
     */
    public func data(data: String, csvSettings: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart data.
     */
    public func data(data: anychart.data.DataSettings, csvSettings: anychart.enums.TextParsingMode) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for the chart data.
     */
    public func data(data: anychart.data.DataSettings, csvSettings: anychart.data.TextParsingSettings) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
...
The data area is drawn along the data bounds.
     ...
     */
    public func draw(async: Bool) -> anychart.charts.HeatMap {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.charts.HeatMap {
     ...
     */
    public func exports(settings: String) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.HeatMap {
     ...
     */
    public func fullScreen(enabled: Bool) -> anychart.charts.HeatMap {
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
     ...
     */
    public func height(height: Double) -> anychart.charts.HeatMap {
...
<b>Note:</b> Works only after {@link anychart.charts.HeatMap#draw} is called.
     ...
     * Setter for chart id.
     */
    public func id(id: String) -> anychart.charts.HeatMap {
     ...
     */
    public func interactivity(settings: String) -> anychart.charts.HeatMap {
     ...
     */
    public func label(settings: Bool) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart label.
     */
    public func label(index: String, settings: Bool) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart label.
     */
    public func label(index: Double, settings: Bool) -> anychart.charts.HeatMap {
     ...
     */
    public func left(left: Double) -> anychart.charts.HeatMap {
     ...
     */
    public func legend(settings: String) -> anychart.charts.HeatMap {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public func margin(margin: [Double]) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public func margin(margin: String) -> anychart.charts.HeatMap {
     ...
     */
    public func margin(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public func margin(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     */
    public func maxHeight(height: Double) -> anychart.charts.HeatMap {
     ...
     */
    public func maxWidth(width: Double) -> anychart.charts.HeatMap {
     ...
     */
    public func minHeight(height: Double) -> anychart.charts.HeatMap {
     ...
     */
    public func minWidth(width: Double) -> anychart.charts.HeatMap {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public func noData(settings: String) -> anychart.charts.HeatMap {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public func padding(padding: [Double]) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public func padding(padding: String) -> anychart.charts.HeatMap {
     ...
     */
    public func padding(value1: String, value2: String, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: String, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: String, value2: Double, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: String, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: String, value4: String) -> anychart.charts.HeatMap {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public func padding(value1: Double, value2: Double, value3: Double, value4: String) -> anychart.charts.HeatMap {
     ...
     */
    public func right(right: Double) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: anychart.graphics.vector.Fill) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(color: [String]) -> anychart.charts.HeatMap {
     ...
     */
    public func selectMarqueeFill(color: String, opacity: Double) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: Bool, opacity: Double) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], angle: Double, mode: String, opacity: Double) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [String], angle: Double, mode: anychart.graphics.vector.Rect, opacity: Double) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(keys: [anychart.graphics.vector.GradientKey], cx: Double, cy: Double, mode: anychart.graphics.math.Rect, opacity: Double, fx: Double, fy: Double) -> anychart.charts.HeatMap {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func selectMarqueeFill(imageSettings: anychart.graphics.vector.Fill) -> anychart.charts.HeatMap {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.HeatMap {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.HeatMap {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.HeatMap {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func selectMarqueeStroke(color: String, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.HeatMap {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public func startSelectMarquee(repeat1: Bool) -> anychart.charts.HeatMap {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.HeatMap {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.HeatMap {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     */
    public func title(settings: Bool) -> anychart.charts.HeatMap {
     ...
     */
    public func tooltip(settings: String) -> anychart.charts.HeatMap {
     ...
     */
    public func top(top: Double) -> anychart.charts.HeatMap {
     ...
     */
    public func width(width: Double) -> anychart.charts.HeatMap {
    ...
    public func yScale() -> anychart.scales.Ordinal {
        return anychart.scales.Ordinal(jsChart: jsBase + ".yScale()")
    }
    /**
    ...
    public func yScroller() -> anychart.core.ui.ChartScroller {
        return anychart.core.ui.ChartScroller(jsChart: jsBase + ".yScroller()")
    }
    /**
     * Setter for the Y scroller.
     */
    public func yScroller(settings: String) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yScroller(%s);", JsObject.wrapQuotes(value: settings)))
    ...
    public func yZoom() -> anychart.core.utils.OrdinalZoom {
        return anychart.core.utils.OrdinalZoom(jsChart: jsBase + ".yZoom()")
    }
    /**
     * Setter for Y Zoom settings.
     */
    public func yZoom(settings: Double) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yZoom(%s);", settings))
    ...
    public func yZoom(settings: String) -> anychart.charts.HeatMap {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".yZoom(%s);", JsObject.wrapQuotes(value: settings)))
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.charts.HeatMap {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.charts.HeatMap {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.charts.HeatMap {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.charts.HeatMap {
