 ...
 extension anychart.core.stock.scrollerseries {
    public class Base: JsObject {
        ...
        public static func instantiate() -> Base {
            return Base(jsChart: "new anychart.core.stock.scrollerSeries.Base()")
        }
     ...
     */
    public func bottom(bottom: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func bounds(bounds: anychart.utils.RectObj) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public func bounds(bounds: anychart.core.utils.Bounds) -> anychart.core.stock.scrollerseries.Base {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".bounds(%s);", (bounds != nil) ? bounds.getJsBase() : "null"))
     ...
     */
    public func bounds(x: Double, y: Double, width: Double, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: Double, width: String, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: Double, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: Double, y: String, width: String, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: Double, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: Double, width: String, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: Double, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for element bounds settings.
     */
    public func bounds(x: String, y: String, width: String, height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func enabled(enabled: Bool) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func height(height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func left(left: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func maxHeight(height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func maxWidth(width: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func minHeight(height: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func minWidth(width: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func right(right: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func top(top: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func width(width: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func zIndex(zIndex: Double) -> anychart.core.stock.scrollerseries.Base {
     ...
     */
    public func container(element: anychart.graphics.vector.Layer) -> anychart.core.stock.scrollerseries.Base {
     ...
     * Setter for the container.
     */
    public func container(element: String) -> anychart.core.stock.scrollerseries.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: anychart.math.Rect) -> anychart.core.stock.scrollerseries.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(bounds: Double) -> anychart.core.stock.scrollerseries.Base {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public func parentBounds(left: Double, top: Double, width: Double, height: Double) -> anychart.core.stock.scrollerseries.Base {
