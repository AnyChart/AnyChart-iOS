 ...
 */
 extension anychart.core.gauge.pointers {
    public class Needle: JsObject {

        override init() {
            super.init()
        }

        public static func instantiate() -> Needle {
            return Needle(jsChart: "new anychart.core.gauge.pointers.Needle()")
        }
        ...
        public init(jsChart: String) {
            ...
            jsBase = "needle\(JsObject.variableIndex)"
     ...
     */
    public func data(data: anychart.data.View, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.gauge.pointers.Needle {
     ...
     * Setter for pointers data.
     */
    public func data(data: anychart.data.Set, csvSettings: anychart.enums.TextParsingMode) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".data(%s, %s);", (data != nil) ? data.getJsBase() : "null", (csvSettings != nil) ? csvSettings.getJsBase() : "null"))
     ...
     * Setter for pointers data.
     */
    public func data(data: [String], csvSettings: anychart.enums.TextParsingMode) -> anychart.core.gauge.pointers.Needle {
    ...
    public func endRadius(radius: Double) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".endRadius(%s);", radius))
    ...
    public func endWidth(width: Double) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".endWidth(%s);", width))
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(color: anychart.graphics.vector.Fill) -> anychart.core.gauge.pointers.Needle {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public func fill(imageSettings: anychart.graphics.vector.Fill) -> anychart.core.gauge.pointers.Needle {
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
    ...
    public func middleRadius(radius: Double) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".middleRadius(%s);", radius))
    ...
    public func middleWidth(width: Double) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".middleWidth(%s);", width))
    ...
    public func startRadius(radius: Double) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".startRadius(%s);", radius))
    ...
    public func startWidth(width: Double) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".startWidth(%s);", width))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gauge.pointers.Needle {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.Stroke, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gauge.pointers.Needle {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: String, lineCap: String) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), JsObject.wrapQuotes(value: lineJoin), JsObject.wrapQuotes(value: lineCap)))
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public func stroke(color: anychart.graphics.vector.ColoredFill, thickness: Double, dashpattern: String, lineJoin: anychart.graphics.vector.StrokeLineJoin, lineCap: String) -> anychart.core.gauge.pointers.Needle {
        APIlib.sharedInstance.jsDelegate?.jsAddLine(jsLine: String(format: jsBase + ".stroke(%s, %s, %s, %s, %s);", (color != nil) ? color.getJsBase() : "null", thickness, JsObject.wrapQuotes(value: dashpattern), (lineJoin != nil) ? lineJoin.getJsBase() : "null", JsObject.wrapQuotes(value: lineCap)))
